...
import org.geotools.data.complex.config.AppSchemaFileDataTest;
import org.geotools.data.complex.config.Types;
import org.geotools.feature.FeatureCollection;
import org.geotools.feature.FeatureIterator;
import org.geotools.feature.NameImpl;
import org.geotools.util.TestsSolrUtils;
...
/**
 * app-schema - Apache Solr Integration Test
 *
 * @author Fernando Miño
 */
public class SolrIntegrationTest extends OnlineTestCase {

    protected static final String SOLR_URL_KEY = "solr_url";
    protected static final String CORE_NAME = "stations";
    private static final String testData = "/test-data/solr/";
    private static final String xmlFileName = "mappings_solr.xml";
    private static final String NSURI = "http://www.stations.org/1.0";
    // private static final Name mappedTypeName = Types.typeName(NSURI, "multi_stations_solr");
    private static final Name mappedTypeName = Types.typeName("multi_stations_solr");
    private static final String testDirStr =
            "target/test/" + SolrIntegrationTest.class.getSimpleName();
    private static final File testDir = new File(testDirStr);

    private static final File appSchemaCacheDir =
            new File(
                    "target/test/"
                            + SolrIntegrationTest.class.getSimpleName()
                            + "/app-schema-cache");
    ...
    public void testFeaturesCount() throws Exception {
        FeatureSource<FeatureType, Feature> fSource =
                (FeatureSource<FeatureType, Feature>)
                        mappingDataStore.getFeatureSource(
                                new NameImpl("http://www.stations.org/1.0", "Station"));
        assertEquals(7, size(fSource.getFeatures()));
    }
    ...
    protected void prepareFiles() throws Exception {
        ...
        File xmlFile =
                URLs.urlToFile(SolrIntegrationTest.class.getResource(testData + xmlFileName));
        Document doc =
