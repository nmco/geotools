...
public class CollectionLinkFunction extends FunctionExpressionImpl {
    ...
    public Object evaluate(Object object) {
        ...
        return MongoComplexUtilities.computeNodeId((String) MongoComplexUtilities.jsonSelect(mongoObjectHolder.getObject(),
                this.params.get(1).toString(), false), mongoObjectHolder.getCollectionInfoHolder().getNodeId());
