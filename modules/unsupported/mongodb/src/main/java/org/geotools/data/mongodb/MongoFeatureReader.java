...
public class MongoFeatureReader implements SimpleFeatureReader {
    ...
    public boolean hasNext() throws IOException {
        ...
        Collection subCollection = (Collection) MongoComplexUtilities.jsonSelect(currentObject, collectionInfoHolder.getObjectsIds(), collectionInfoHolder.getCollectionPath(), false);
