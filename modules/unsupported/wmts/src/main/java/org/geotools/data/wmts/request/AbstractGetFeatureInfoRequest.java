 ...
 * @source $URL$
 */
public abstract class AbstractGetFeatureInfoRequest extends AbstractWMTSRequest implements GetFeatureInfoRequest {
     ...
     */
    public AbstractGetFeatureInfoRequest( URL onlineResource, GetTileRequest request) {
     ...
     * @return
     */
    static Properties getMapProperties(GetTileRequest request) {
        request.getFinalURL();
