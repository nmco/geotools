...
public final class GroupByVisitorBuilder {
    ...
    private GroupByVisitor.AggregateVisitor aggregateVisitor;
    ...
    public GroupByVisitorBuilder withAggregateVisitor(GroupByVisitor.AggregateVisitor aggregateVisitor) {
        this.aggregateVisitor = aggregateVisitor;
        return this;
    }

    public GroupByVisitorBuilder withAggregateVisitor(String aggregateVisitorName) {
        this.aggregateVisitor = GroupByVisitor.AggregateVisitor.valueOf(aggregateVisitorName);
        return this;
    }
