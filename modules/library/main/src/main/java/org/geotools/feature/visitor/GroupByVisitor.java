...
public class GroupByVisitor implements FeatureCalc {
     ...
     */
    public enum AggregateVisitor {

        Average {
            @Override
            protected FeatureCalc create(Expression aggregateAttribute) {
                return new AverageVisitor(aggregateAttribute);
            }

            @Override
            protected CalcResult wrap(Expression aggregateAttribute, Object value) {
        ...
        /**
         * Creates a new visitor using an aggregate visitor.
         *
         * @param aggregateAttribute the aggregate attribute to be used by the visitor
         * @return a new instance of the visitor
         */
        protected abstract FeatureCalc create(Expression aggregateAttribute);
         ...
         */
        protected abstract CalcResult wrap(Expression aggregateAttribute, Object value);
    }
    ...
    public GroupByVisitor(AggregateVisitor aggregateVisitor, Expression aggregateAttribute, List<Expression> groupByAttributes) {
        this(aggregateVisitor, aggregateAttribute, groupByAttributes, new NullProgressListener());
    }

    public GroupByVisitor(AggregateVisitor aggregateVisitor, Expression aggregateAttribute,
    ...
    public boolean visited() {
        return !(optimizationResult == CalcResult.NULL_RESULT && inMemoryGroupBy.groupByIndexes.isEmpty());
    }
    ...
    public static class GroupByResult implements CalcResult {
        ...
        public GroupByResult(Map<List<Object>, CalcResult> results, AggregateVisitor aggregateVisitor, List<Expression> groupByAttributes) {
        ...
        public AggregateVisitor getAggregateVisitor() {
