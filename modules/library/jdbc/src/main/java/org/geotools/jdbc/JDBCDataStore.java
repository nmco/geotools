...
//    }
     ...
     * @param query       Specifies rows to include in bounds calculation, as well as how many features and
     ...
     * </ul>
     *
     * @param t The GeoTools transaction. Can be {@code null}, in that case a new connection will
     ...
     *
     * @param featureType the feature type that the query must return (may contain less
     *                    attributes than the native one)
     * @param attributes  the properties queried, or {@link Query#ALL_NAMES} to gather
     *                    all of them
     ...
     * @param query       the query to be run. The type name and property will be ignored, as they are
     *                    supposed to have been already embedded into the provided feature type
     * @param cx          The database connection to be used to create the prepared
     *                    statement
     */
    ...
    protected String selectCountSQL(SimpleFeatureType featureType, Query query, LimitingVisitor visitor) throws SQLException, IOException {
        ...
        return selectAggregateSQL("count", null, null, featureType, query, visitor);
    }
    ...
    protected PreparedStatement selectCountSQLPS(SimpleFeatureType featureType, Query query, LimitingVisitor visitor, Connection cx)
        ...
        return selectAggregateSQLPS("count", null, null, featureType, query, visitor, cx);
    }
