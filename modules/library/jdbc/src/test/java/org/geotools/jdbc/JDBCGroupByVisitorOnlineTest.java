...
public abstract class JDBCGroupByVisitorOnlineTest extends JDBCTestSupport {
    ...
    public void testSimpleGroupByWithMax() throws Exception {
        List<Object[]> value = genericGroupByTestTest(GroupByVisitor.AggregateVisitor.Max, "building_type");
    ...
    public void testMultipleGroupByWithMax() throws Exception {
        List<Object[]> value = genericGroupByTestTest(GroupByVisitor.AggregateVisitor.Max, "building_type", "energy_type");
    ...
    public void testSimpleGroupByWithMin() throws Exception {
        List<Object[]> value = genericGroupByTestTest(GroupByVisitor.AggregateVisitor.Min, "building_type");
    ...
    public void testMultipleGroupByWithMin() throws Exception {
        List<Object[]> value = genericGroupByTestTest(GroupByVisitor.AggregateVisitor.Min, "building_type", "energy_type");
        checkValueContains(value, "SCHOOL", "WIND", "20.0");
        checkValueContains(value, "SCHOOL", "FUEL", "60.0");
        checkValueContains(value, "HOUSE", "NUCLEAR", "4.0");
        checkValueContains(value, "SCHOOL", "SOLAR", "30.0");
    ...
    public void testSimpleGroupByWithCount() throws Exception {
        List<Object[]> value = genericGroupByTestTest(GroupByVisitor.AggregateVisitor.Count, "building_type");
    ...
    public void testMultipleGroupByWithCount() throws Exception {
        List<Object[]> value = genericGroupByTestTest(GroupByVisitor.AggregateVisitor.Count, "building_type", "energy_type");
    ...
    public void testSimpleGroupByWithSum() throws Exception {
        List<Object[]> value = genericGroupByTestTest(GroupByVisitor.AggregateVisitor.Sum, "building_type");
    ...
    public void testMultipleGroupByWithSum() throws Exception {
        List<Object[]> value = genericGroupByTestTest(GroupByVisitor.AggregateVisitor.Sum, "building_type", "energy_type");
        checkValueContains(value, "FABRIC", "FLOWING_WATER", "500.0");
        checkValueContains(value, "FABRIC", "NUCLEAR", "150.0");
        checkValueContains(value, "FABRIC", "SOLAR", "30.0");
        checkValueContains(value, "FABRIC", "WIND", "20.0");
    ...
    private List<Object[]> genericGroupByTestTest(GroupByVisitor.AggregateVisitor aggregateVisitor,
