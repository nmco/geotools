...
import net.opengis.wmts.v_11.GetCapabilitiesValueType;
import net.opengis.wmts.v_11.GetFeatureInfoType;
import net.opengis.wmts.v_11.GetFeatureInfoValueType;
import net.opengis.wmts.v_11.GetTileType;
import net.opengis.wmts.v_11.GetTileValueType;
import net.opengis.wmts.v_11.LayerType;
import net.opengis.wmts.v_11.LegendURLType;
import net.opengis.wmts.v_11.RequestServiceType;
...
import net.opengis.wmts.v_11.VersionType;

import net.opengis.wmts.v_11.util.wmts11Validator;
 ...
 * @generated
 */
public class wmts11PackageImpl extends EPackageImpl implements wmts11Package {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     ...
     * @see net.opengis.wmts.v_11.wmts11Package#eNS_URI
     * @see #init()
     * @generated
     */
    private wmts11PackageImpl() {
        super(eNS_URI, wmts11Factory.eINSTANCE);
    }
     ...
     * 
     * <p>This method is used to initialize {@link wmts11Package#eINSTANCE} when that field is accessed.
     ...
     * @generated
     */
    public static wmts11Package init() {
        if (isInited) return (wmts11Package)EPackage.Registry.INSTANCE.getEPackage(wmts11Package.eNS_URI);

        // Obtain or create and register package
        wmts11PackageImpl thewmts11Package = (wmts11PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof wmts11PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new wmts11PackageImpl());
            ...
            (thewmts11Package, 
             new EValidator.Descriptor() {
                 public EValidator getEValidator() {
                     return wmts11Validator.INSTANCE;
                 }
             });

        // Mark meta-data to indicate it can't be changed
        thewmts11Package.freeze();

  
        // Update the registry and return the package
        EPackage.Registry.INSTANCE.put(wmts11Package.eNS_URI, thewmts11Package);
        return thewmts11Package;
    }
     ...
     * @generated
     */
    public wmts11Factory getwmts11Factory() {
        return (wmts11Factory)getEFactoryInstance();
    }
    ...
    public void initializePackageContents() {
        ...
        initEReference(getFeatureInfoResponseType_FeatureCollection(), theGmlPackage.getAbstractFeatureCollectionType(), null, "featureCollection", null, 0, 1, FeatureInfoResponseType.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
