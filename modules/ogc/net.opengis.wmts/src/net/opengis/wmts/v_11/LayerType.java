 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts._1.LayerType#getStyle <em>Style</em>}</li>
 *   <li>{@link net.opengis.wmts._1.LayerType#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wmts._1.LayerType#getInfoFormat <em>Info Format</em>}</li>
 *   <li>{@link net.opengis.wmts._1.LayerType#getDimension <em>Dimension</em>}</li>
 *   <li>{@link net.opengis.wmts._1.LayerType#getTileMatrixSetLink <em>Tile Matrix Set Link</em>}</li>
 *   <li>{@link net.opengis.wmts._1.LayerType#getResourceURL <em>Resource URL</em>}</li>
 * </ul>
 *
 * @see net.opengis.wmts._1.wmts11Package#getLayerType()
...
public interface LayerType extends DatasetDescriptionSummaryBaseType {
     ...
     * The list contents are of type {@link net.opengis.wmts._1.StyleType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getLayerType_Style()
     ...
     * @see net.opengis.wmts._1.wmts11Package#getLayerType_Format()
     ...
     * @see net.opengis.wmts._1.wmts11Package#getLayerType_InfoFormat()
     ...
     * The list contents are of type {@link net.opengis.wmts._1.DimensionType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getLayerType_Dimension()
     ...
     * The list contents are of type {@link net.opengis.wmts._1.TileMatrixSetLinkType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getLayerType_TileMatrixSetLink()
     * @model containment="true" required="true"
     ...
     * The list contents are of type {@link net.opengis.wmts._1.URLTemplateType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * 
     ...
     * @see net.opengis.wmts._1.wmts11Package#getLayerType_ResourceURL()
     * @model containment="true"
