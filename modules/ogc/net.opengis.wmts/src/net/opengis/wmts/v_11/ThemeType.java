 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts._1.ThemeType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wmts._1.ThemeType#getTheme <em>Theme</em>}</li>
 *   <li>{@link net.opengis.wmts._1.ThemeType#getLayerRef <em>Layer Ref</em>}</li>
 * </ul>
 *
 * @see net.opengis.wmts._1.wmts11Package#getThemeType()
...
public interface ThemeType extends DescriptionType {
     ...
     * @see net.opengis.wmts._1.wmts11Package#getThemeType_Identifier()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.ThemeType#getIdentifier <em>Identifier</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getThemeType_Theme()
     ...
     * @see net.opengis.wmts._1.wmts11Package#getThemeType_LayerRef()
