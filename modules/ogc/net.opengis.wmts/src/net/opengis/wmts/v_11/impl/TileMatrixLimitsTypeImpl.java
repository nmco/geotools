 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixLimitsTypeImpl#getTileMatrix <em>Tile Matrix</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixLimitsTypeImpl#getMinTileRow <em>Min Tile Row</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixLimitsTypeImpl#getMaxTileRow <em>Max Tile Row</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixLimitsTypeImpl#getMinTileCol <em>Min Tile Col</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixLimitsTypeImpl#getMaxTileCol <em>Max Tile Col</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TileMatrixLimitsTypeImpl extends MinimalEObjectImpl.Container implements TileMatrixLimitsType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.TILE_MATRIX_LIMITS_TYPE;
    }
    ...
    public void setTileMatrix(String newTileMatrix) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_LIMITS_TYPE__TILE_MATRIX, oldTileMatrix, tileMatrix));
    }
    ...
    public void setMinTileRow(BigInteger newMinTileRow) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_LIMITS_TYPE__MIN_TILE_ROW, oldMinTileRow, minTileRow));
    }
    ...
    public void setMaxTileRow(BigInteger newMaxTileRow) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_LIMITS_TYPE__MAX_TILE_ROW, oldMaxTileRow, maxTileRow));
    }
    ...
    public void setMinTileCol(BigInteger newMinTileCol) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_LIMITS_TYPE__MIN_TILE_COL, oldMinTileCol, minTileCol));
    }
    ...
    public void setMaxTileCol(BigInteger newMaxTileCol) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_LIMITS_TYPE__MAX_TILE_COL, oldMaxTileCol, maxTileCol));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wmts11Package.TILE_MATRIX_LIMITS_TYPE__TILE_MATRIX:
                return getTileMatrix();
            case wmts11Package.TILE_MATRIX_LIMITS_TYPE__MIN_TILE_ROW:
                return getMinTileRow();
            case wmts11Package.TILE_MATRIX_LIMITS_TYPE__MAX_TILE_ROW:
                return getMaxTileRow();
            case wmts11Package.TILE_MATRIX_LIMITS_TYPE__MIN_TILE_COL:
                return getMinTileCol();
            case wmts11Package.TILE_MATRIX_LIMITS_TYPE__MAX_TILE_COL:
