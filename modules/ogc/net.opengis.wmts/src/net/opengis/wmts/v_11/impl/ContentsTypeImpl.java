 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.ContentsTypeImpl#getTileMatrixSet <em>Tile Matrix Set</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContentsTypeImpl extends ContentsBaseTypeImpl implements ContentsType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.CONTENTS_TYPE;
    }
    ...
    public EList<TileMatrixSetType> getTileMatrixSet() {
        if (tileMatrixSet == null) {
            tileMatrixSet = new EObjectContainmentEList<TileMatrixSetType>(TileMatrixSetType.class, this, wmts11Package.CONTENTS_TYPE__TILE_MATRIX_SET);
        }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wmts11Package.CONTENTS_TYPE__TILE_MATRIX_SET:
