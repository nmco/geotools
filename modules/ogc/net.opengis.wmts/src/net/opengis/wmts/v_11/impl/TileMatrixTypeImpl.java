 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixTypeImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixTypeImpl#getScaleDenominator <em>Scale Denominator</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixTypeImpl#getTopLeftCorner <em>Top Left Corner</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixTypeImpl#getTileWidth <em>Tile Width</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixTypeImpl#getTileHeight <em>Tile Height</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixTypeImpl#getMatrixWidth <em>Matrix Width</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixTypeImpl#getMatrixHeight <em>Matrix Height</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TileMatrixTypeImpl extends DescriptionTypeImpl implements TileMatrixType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.TILE_MATRIX_TYPE;
    }
    ...
    public NotificationChain basicSetIdentifier(CodeType newIdentifier, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_TYPE__IDENTIFIER, oldIdentifier, newIdentifier);
    ...
    public void setIdentifier(CodeType newIdentifier) {
        if (newIdentifier != identifier) {
            ...
            if (identifier != null)
                msgs = ((InternalEObject)identifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - wmts11Package.TILE_MATRIX_TYPE__IDENTIFIER, null, msgs);
            if (newIdentifier != null)
                msgs = ((InternalEObject)newIdentifier).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - wmts11Package.TILE_MATRIX_TYPE__IDENTIFIER, null, msgs);
            msgs = basicSetIdentifier(newIdentifier, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_TYPE__IDENTIFIER, newIdentifier, newIdentifier));
    }
    ...
    public void setScaleDenominator(double newScaleDenominator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_TYPE__SCALE_DENOMINATOR, oldScaleDenominator, scaleDenominator, !oldScaleDenominatorESet));
    }
    ...
    public void unsetScaleDenominator() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, wmts11Package.TILE_MATRIX_TYPE__SCALE_DENOMINATOR, oldScaleDenominator, SCALE_DENOMINATOR_EDEFAULT, oldScaleDenominatorESet));
    }
    ...
    public void setTopLeftCorner(List<Double> newTopLeftCorner) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_TYPE__TOP_LEFT_CORNER, oldTopLeftCorner, topLeftCorner));
    }
    ...
    public void setTileWidth(BigInteger newTileWidth) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_TYPE__TILE_WIDTH, oldTileWidth, tileWidth));
    }
    ...
    public void setTileHeight(BigInteger newTileHeight) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_TYPE__TILE_HEIGHT, oldTileHeight, tileHeight));
    }
    ...
    public void setMatrixWidth(BigInteger newMatrixWidth) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_TYPE__MATRIX_WIDTH, oldMatrixWidth, matrixWidth));
    }
    ...
    public void setMatrixHeight(BigInteger newMatrixHeight) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_TYPE__MATRIX_HEIGHT, oldMatrixHeight, matrixHeight));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wmts11Package.TILE_MATRIX_TYPE__IDENTIFIER:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case wmts11Package.TILE_MATRIX_TYPE__SCALE_DENOMINATOR:
                return getScaleDenominator();
            case wmts11Package.TILE_MATRIX_TYPE__TOP_LEFT_CORNER:
                return getTopLeftCorner();
            case wmts11Package.TILE_MATRIX_TYPE__TILE_WIDTH:
                return getTileWidth();
            case wmts11Package.TILE_MATRIX_TYPE__TILE_HEIGHT:
                return getTileHeight();
            case wmts11Package.TILE_MATRIX_TYPE__MATRIX_WIDTH:
                return getMatrixWidth();
            case wmts11Package.TILE_MATRIX_TYPE__MATRIX_HEIGHT:
