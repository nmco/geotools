 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts._1.TextPayloadType#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wmts._1.TextPayloadType#getTextContent <em>Text Content</em>}</li>
 * </ul>
 *
 * @see net.opengis.wmts._1.wmts11Package#getTextPayloadType()
...
public interface TextPayloadType extends EObject {
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTextPayloadType_Format()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TextPayloadType#getFormat <em>Format</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTextPayloadType_TextContent()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TextPayloadType#getTextContent <em>Text Content</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
