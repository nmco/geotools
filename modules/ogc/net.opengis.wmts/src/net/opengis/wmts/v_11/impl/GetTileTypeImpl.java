 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetTileTypeImpl#getLayer <em>Layer</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetTileTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetTileTypeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetTileTypeImpl#getDimensionNameValue <em>Dimension Name Value</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetTileTypeImpl#getTileMatrixSet <em>Tile Matrix Set</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetTileTypeImpl#getTileMatrix <em>Tile Matrix</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetTileTypeImpl#getTileRow <em>Tile Row</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetTileTypeImpl#getTileCol <em>Tile Col</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetTileTypeImpl#getService <em>Service</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetTileTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetTileTypeImpl extends MinimalEObjectImpl.Container implements GetTileType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.GET_TILE_TYPE;
    }
    ...
    public void setLayer(String newLayer) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_TILE_TYPE__LAYER, oldLayer, layer));
    }
    ...
    public void setStyle(String newStyle) {
        ...
        style = newStyle;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_TILE_TYPE__STYLE, oldStyle, style));
    }
    ...
    public void setFormat(String newFormat) {
        ...
        format = newFormat;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_TILE_TYPE__FORMAT, oldFormat, format));
    }
    ...
    public EList<DimensionNameValueType> getDimensionNameValue() {
        if (dimensionNameValue == null) {
            dimensionNameValue = new EObjectContainmentEList<DimensionNameValueType>(DimensionNameValueType.class, this, wmts11Package.GET_TILE_TYPE__DIMENSION_NAME_VALUE);
        }
    ...
    public void setTileMatrixSet(String newTileMatrixSet) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_TILE_TYPE__TILE_MATRIX_SET, oldTileMatrixSet, tileMatrixSet));
    }
    ...
    public void setTileMatrix(String newTileMatrix) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_TILE_TYPE__TILE_MATRIX, oldTileMatrix, tileMatrix));
    }
    ...
    public void setTileRow(BigInteger newTileRow) {
        ...
        tileRow = newTileRow;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_TILE_TYPE__TILE_ROW, oldTileRow, tileRow));
    }
    ...
    public void setTileCol(BigInteger newTileCol) {
        ...
        tileCol = newTileCol;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_TILE_TYPE__TILE_COL, oldTileCol, tileCol));
    }
    ...
    public void setService(String newService) {
        ...
        serviceESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_TILE_TYPE__SERVICE, oldService, service, !oldServiceESet));
    }
    ...
    public void unsetService() {
        ...
        serviceESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, wmts11Package.GET_TILE_TYPE__SERVICE, oldService, SERVICE_EDEFAULT, oldServiceESet));
    }
    ...
    public void setVersion(String newVersion) {
        ...
        versionESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_TILE_TYPE__VERSION, oldVersion, version, !oldVersionESet));
    }
    ...
    public void unsetVersion() {
        ...
        versionESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, wmts11Package.GET_TILE_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wmts11Package.GET_TILE_TYPE__DIMENSION_NAME_VALUE:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wmts11Package.GET_TILE_TYPE__LAYER:
                return getLayer();
            case wmts11Package.GET_TILE_TYPE__STYLE:
                return getStyle();
            case wmts11Package.GET_TILE_TYPE__FORMAT:
                return getFormat();
            case wmts11Package.GET_TILE_TYPE__DIMENSION_NAME_VALUE:
                return getDimensionNameValue();
            case wmts11Package.GET_TILE_TYPE__TILE_MATRIX_SET:
                return getTileMatrixSet();
            case wmts11Package.GET_TILE_TYPE__TILE_MATRIX:
                return getTileMatrix();
            case wmts11Package.GET_TILE_TYPE__TILE_ROW:
                return getTileRow();
            case wmts11Package.GET_TILE_TYPE__TILE_COL:
                return getTileCol();
            case wmts11Package.GET_TILE_TYPE__SERVICE:
                return getService();
            case wmts11Package.GET_TILE_TYPE__VERSION:
                return getVersion();
        }
