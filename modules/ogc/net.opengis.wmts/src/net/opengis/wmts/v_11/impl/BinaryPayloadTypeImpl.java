 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.BinaryPayloadTypeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.BinaryPayloadTypeImpl#getBinaryContent <em>Binary Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BinaryPayloadTypeImpl extends MinimalEObjectImpl.Container implements BinaryPayloadType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.BINARY_PAYLOAD_TYPE;
    }
    ...
    public void setFormat(String newFormat) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.BINARY_PAYLOAD_TYPE__FORMAT, oldFormat, format));
    }
    ...
    public void setBinaryContent(byte[] newBinaryContent) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.BINARY_PAYLOAD_TYPE__BINARY_CONTENT, oldBinaryContent, binaryContent));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wmts11Package.BINARY_PAYLOAD_TYPE__FORMAT:
                return getFormat();
            case wmts11Package.BINARY_PAYLOAD_TYPE__BINARY_CONTENT:
