 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.LayerTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.LayerTypeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.LayerTypeImpl#getInfoFormat <em>Info Format</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.LayerTypeImpl#getDimension <em>Dimension</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.LayerTypeImpl#getTileMatrixSetLink <em>Tile Matrix Set Link</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.LayerTypeImpl#getResourceURL <em>Resource URL</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LayerTypeImpl extends DatasetDescriptionSummaryBaseTypeImpl implements LayerType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.LAYER_TYPE;
    }
    ...
    public EList<StyleType> getStyle() {
        if (style == null) {
            style = new EObjectContainmentEList<StyleType>(StyleType.class, this, wmts11Package.LAYER_TYPE__STYLE);
        }
        return style;
    }
    ...
    public EList<String> getFormat() {
        if (format == null) {
            format = new EDataTypeEList<String>(String.class, this, wmts11Package.LAYER_TYPE__FORMAT);
        }
        return format;
    }
    ...
    public EList<String> getInfoFormat() {
        if (infoFormat == null) {
            infoFormat = new EDataTypeEList<String>(String.class, this, wmts11Package.LAYER_TYPE__INFO_FORMAT);
        }
        return infoFormat;
    }
    ...
    public EList<DimensionType> getDimension() {
        if (dimension == null) {
            dimension = new EObjectContainmentEList<DimensionType>(DimensionType.class, this, wmts11Package.LAYER_TYPE__DIMENSION);
        }
        return dimension;
    }
    ...
    public EList<TileMatrixSetLinkType> getTileMatrixSetLink() {
        if (tileMatrixSetLink == null) {
            tileMatrixSetLink = new EObjectContainmentEList<TileMatrixSetLinkType>(TileMatrixSetLinkType.class, this, wmts11Package.LAYER_TYPE__TILE_MATRIX_SET_LINK);
        }
    ...
    public EList<URLTemplateType> getResourceURL() {
        if (resourceURL == null) {
            resourceURL = new EObjectContainmentEList<URLTemplateType>(URLTemplateType.class, this, wmts11Package.LAYER_TYPE__RESOURCE_URL);
        }
        return resourceURL;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wmts11Package.LAYER_TYPE__STYLE:
                return getStyle();
            case wmts11Package.LAYER_TYPE__FORMAT:
                return getFormat();
            case wmts11Package.LAYER_TYPE__INFO_FORMAT:
