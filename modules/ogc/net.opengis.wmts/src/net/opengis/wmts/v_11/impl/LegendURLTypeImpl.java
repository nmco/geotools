 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.LegendURLTypeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.LegendURLTypeImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.LegendURLTypeImpl#getMaxScaleDenominator <em>Max Scale Denominator</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.LegendURLTypeImpl#getMinScaleDenominator <em>Min Scale Denominator</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.LegendURLTypeImpl#getWidth <em>Width</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LegendURLTypeImpl extends OnlineResourceTypeImpl implements LegendURLType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.LEGEND_URL_TYPE;
    }
    ...
    public void setFormat(String newFormat) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.LEGEND_URL_TYPE__FORMAT, oldFormat, format));
    }
    ...
    public void setHeight(BigInteger newHeight) {
        ...
        height = newHeight;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.LEGEND_URL_TYPE__HEIGHT, oldHeight, height));
    }
    ...
    public void setMaxScaleDenominator(double newMaxScaleDenominator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.LEGEND_URL_TYPE__MAX_SCALE_DENOMINATOR, oldMaxScaleDenominator, maxScaleDenominator, !oldMaxScaleDenominatorESet));
    }
    ...
    public void unsetMaxScaleDenominator() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, wmts11Package.LEGEND_URL_TYPE__MAX_SCALE_DENOMINATOR, oldMaxScaleDenominator, MAX_SCALE_DENOMINATOR_EDEFAULT, oldMaxScaleDenominatorESet));
    }
    ...
    public void setMinScaleDenominator(double newMinScaleDenominator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.LEGEND_URL_TYPE__MIN_SCALE_DENOMINATOR, oldMinScaleDenominator, minScaleDenominator, !oldMinScaleDenominatorESet));
    }
    ...
    public void unsetMinScaleDenominator() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, wmts11Package.LEGEND_URL_TYPE__MIN_SCALE_DENOMINATOR, oldMinScaleDenominator, MIN_SCALE_DENOMINATOR_EDEFAULT, oldMinScaleDenominatorESet));
    }
    ...
    public void setWidth(BigInteger newWidth) {
        ...
        width = newWidth;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.LEGEND_URL_TYPE__WIDTH, oldWidth, width));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wmts11Package.LEGEND_URL_TYPE__FORMAT:
                return getFormat();
            case wmts11Package.LEGEND_URL_TYPE__HEIGHT:
                return getHeight();
            case wmts11Package.LEGEND_URL_TYPE__MAX_SCALE_DENOMINATOR:
                return getMaxScaleDenominator();
            case wmts11Package.LEGEND_URL_TYPE__MIN_SCALE_DENOMINATOR:
                return getMinScaleDenominator();
            case wmts11Package.LEGEND_URL_TYPE__WIDTH:
                return getWidth();
        }
