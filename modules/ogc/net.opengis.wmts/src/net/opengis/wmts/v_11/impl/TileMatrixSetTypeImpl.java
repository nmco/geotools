 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixSetTypeImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixSetTypeImpl#getBoundingBoxGroup <em>Bounding Box Group</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixSetTypeImpl#getBoundingBox <em>Bounding Box</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixSetTypeImpl#getSupportedCRS <em>Supported CRS</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixSetTypeImpl#getWellKnownScaleSet <em>Well Known Scale Set</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixSetTypeImpl#getTileMatrix <em>Tile Matrix</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TileMatrixSetTypeImpl extends DescriptionTypeImpl implements TileMatrixSetType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.TILE_MATRIX_SET_TYPE;
    }
    ...
    public NotificationChain basicSetIdentifier(CodeType newIdentifier, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_SET_TYPE__IDENTIFIER, oldIdentifier, newIdentifier);
    ...
    public void setIdentifier(CodeType newIdentifier) {
        if (newIdentifier != identifier) {
            ...
            if (identifier != null)
                msgs = ((InternalEObject)identifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - wmts11Package.TILE_MATRIX_SET_TYPE__IDENTIFIER, null, msgs);
            if (newIdentifier != null)
                msgs = ((InternalEObject)newIdentifier).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - wmts11Package.TILE_MATRIX_SET_TYPE__IDENTIFIER, null, msgs);
            msgs = basicSetIdentifier(newIdentifier, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_SET_TYPE__IDENTIFIER, newIdentifier, newIdentifier));
    }
    ...
    public FeatureMap getBoundingBoxGroup() {
        if (boundingBoxGroup == null) {
            boundingBoxGroup = new BasicFeatureMap(this, wmts11Package.TILE_MATRIX_SET_TYPE__BOUNDING_BOX_GROUP);
        }
    ...
    public BoundingBoxType getBoundingBox() {
        return (BoundingBoxType)getBoundingBoxGroup().get(wmts11Package.Literals.TILE_MATRIX_SET_TYPE__BOUNDING_BOX, true);
    }
    ...
    public NotificationChain basicSetBoundingBox(BoundingBoxType newBoundingBox, NotificationChain msgs) {
        return ((FeatureMap.Internal)getBoundingBoxGroup()).basicAdd(wmts11Package.Literals.TILE_MATRIX_SET_TYPE__BOUNDING_BOX, newBoundingBox, msgs);
    }
    ...
    public void setBoundingBox(BoundingBoxType newBoundingBox) {
        ((FeatureMap.Internal)getBoundingBoxGroup()).set(wmts11Package.Literals.TILE_MATRIX_SET_TYPE__BOUNDING_BOX, newBoundingBox);
    }
    ...
    public void setSupportedCRS(String newSupportedCRS) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_SET_TYPE__SUPPORTED_CRS, oldSupportedCRS, supportedCRS));
    }
    ...
    public void setWellKnownScaleSet(String newWellKnownScaleSet) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_SET_TYPE__WELL_KNOWN_SCALE_SET, oldWellKnownScaleSet, wellKnownScaleSet));
    }
    ...
    public EList<TileMatrixType> getTileMatrix() {
        if (tileMatrix == null) {
            tileMatrix = new EObjectContainmentEList<TileMatrixType>(TileMatrixType.class, this, wmts11Package.TILE_MATRIX_SET_TYPE__TILE_MATRIX);
        }
        return tileMatrix;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wmts11Package.TILE_MATRIX_SET_TYPE__IDENTIFIER:
                return basicSetIdentifier(null, msgs);
            case wmts11Package.TILE_MATRIX_SET_TYPE__BOUNDING_BOX_GROUP:
                return ((InternalEList<?>)getBoundingBoxGroup()).basicRemove(otherEnd, msgs);
            case wmts11Package.TILE_MATRIX_SET_TYPE__BOUNDING_BOX:
                return basicSetBoundingBox(null, msgs);
            case wmts11Package.TILE_MATRIX_SET_TYPE__TILE_MATRIX:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case wmts11Package.TILE_MATRIX_SET_TYPE__SUPPORTED_CRS:
                return getSupportedCRS();
            case wmts11Package.TILE_MATRIX_SET_TYPE__WELL_KNOWN_SCALE_SET:
