 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.URLTemplateTypeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.URLTemplateTypeImpl#getResourceType <em>Resource Type</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.URLTemplateTypeImpl#getTemplate <em>Template</em>}</li>
 * </ul>
 *
 * @generated
 */
public class URLTemplateTypeImpl extends MinimalEObjectImpl.Container implements URLTemplateType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.URL_TEMPLATE_TYPE;
    }
    ...
    public void setFormat(String newFormat) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.URL_TEMPLATE_TYPE__FORMAT, oldFormat, format));
    }
    ...
    public void setResourceType(ResourceTypeType newResourceType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.URL_TEMPLATE_TYPE__RESOURCE_TYPE, oldResourceType, resourceType, !oldResourceTypeESet));
    }
    ...
    public void unsetResourceType() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, wmts11Package.URL_TEMPLATE_TYPE__RESOURCE_TYPE, oldResourceType, RESOURCE_TYPE_EDEFAULT, oldResourceTypeESet));
    }
    ...
    public void setTemplate(String newTemplate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.URL_TEMPLATE_TYPE__TEMPLATE, oldTemplate, template));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wmts11Package.URL_TEMPLATE_TYPE__FORMAT:
                return getFormat();
            case wmts11Package.URL_TEMPLATE_TYPE__RESOURCE_TYPE:
                return getResourceType();
            case wmts11Package.URL_TEMPLATE_TYPE__TEMPLATE:
                return getTemplate();
        }
