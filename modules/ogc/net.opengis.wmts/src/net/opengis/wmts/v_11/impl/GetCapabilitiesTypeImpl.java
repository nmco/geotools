 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetCapabilitiesTypeImpl#getService <em>Service</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetCapabilitiesTypeImpl extends net.opengis.ows11.impl.GetCapabilitiesTypeImpl implements GetCapabilitiesType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.GET_CAPABILITIES_TYPE;
    }
    ...
    public void setService(String newService) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_CAPABILITIES_TYPE__SERVICE, oldService, service, !oldServiceESet));
    }
    ...
    public void unsetService() {
        ...
        serviceESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, wmts11Package.GET_CAPABILITIES_TYPE__SERVICE, oldService, SERVICE_EDEFAULT, oldServiceESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wmts11Package.GET_CAPABILITIES_TYPE__SERVICE:
                return getService();
        }
