 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts._1.FeatureInfoResponseType#getFeatureCollectionGroup <em>Feature Collection Group</em>}</li>
 *   <li>{@link net.opengis.wmts._1.FeatureInfoResponseType#getFeatureCollection <em>Feature Collection</em>}</li>
 *   <li>{@link net.opengis.wmts._1.FeatureInfoResponseType#getTextPayload <em>Text Payload</em>}</li>
 *   <li>{@link net.opengis.wmts._1.FeatureInfoResponseType#getBinaryPayload <em>Binary Payload</em>}</li>
 *   <li>{@link net.opengis.wmts._1.FeatureInfoResponseType#getAnyContent <em>Any Content</em>}</li>
 * </ul>
 *
 * @see net.opengis.wmts._1.wmts11Package#getFeatureInfoResponseType()
...
public interface FeatureInfoResponseType extends EObject {
     ...
     * @see net.opengis.wmts._1.wmts11Package#getFeatureInfoResponseType_FeatureCollectionGroup()
     ...
     * @see net.opengis.wmts._1.wmts11Package#getFeatureInfoResponseType_FeatureCollection()
     ...
     * @see net.opengis.wmts._1.wmts11Package#getFeatureInfoResponseType_TextPayload()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.FeatureInfoResponseType#getTextPayload <em>Text Payload</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getFeatureInfoResponseType_BinaryPayload()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.FeatureInfoResponseType#getBinaryPayload <em>Binary Payload</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getFeatureInfoResponseType_AnyContent()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.FeatureInfoResponseType#getAnyContent <em>Any Content</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
