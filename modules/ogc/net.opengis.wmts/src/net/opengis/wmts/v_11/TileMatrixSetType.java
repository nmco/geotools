 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts._1.TileMatrixSetType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wmts._1.TileMatrixSetType#getBoundingBoxGroup <em>Bounding Box Group</em>}</li>
 *   <li>{@link net.opengis.wmts._1.TileMatrixSetType#getBoundingBox <em>Bounding Box</em>}</li>
 *   <li>{@link net.opengis.wmts._1.TileMatrixSetType#getSupportedCRS <em>Supported CRS</em>}</li>
 *   <li>{@link net.opengis.wmts._1.TileMatrixSetType#getWellKnownScaleSet <em>Well Known Scale Set</em>}</li>
 *   <li>{@link net.opengis.wmts._1.TileMatrixSetType#getTileMatrix <em>Tile Matrix</em>}</li>
 * </ul>
 *
 * @see net.opengis.wmts._1.wmts11Package#getTileMatrixSetType()
...
public interface TileMatrixSetType extends DescriptionType {
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixSetType_Identifier()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TileMatrixSetType#getIdentifier <em>Identifier</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixSetType_BoundingBoxGroup()
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixSetType_BoundingBox()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TileMatrixSetType#getBoundingBox <em>Bounding Box</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixSetType_SupportedCRS()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TileMatrixSetType#getSupportedCRS <em>Supported CRS</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixSetType_WellKnownScaleSet()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TileMatrixSetType#getWellKnownScaleSet <em>Well Known Scale Set</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link net.opengis.wmts._1.TileMatrixType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixSetType_TileMatrix()
     * @model containment="true" required="true"
