 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts._1.URLTemplateType#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wmts._1.URLTemplateType#getResourceType <em>Resource Type</em>}</li>
 *   <li>{@link net.opengis.wmts._1.URLTemplateType#getTemplate <em>Template</em>}</li>
 * </ul>
 *
 * @see net.opengis.wmts._1.wmts11Package#getURLTemplateType()
...
public interface URLTemplateType extends EObject {
     ...
     * @see net.opengis.wmts._1.wmts11Package#getURLTemplateType_Format()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.URLTemplateType#getFormat <em>Format</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The literals are from the enumeration {@link net.opengis.wmts._1.ResourceTypeType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getURLTemplateType_ResourceType()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.URLTemplateType#getResourceType <em>Resource Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wmts._1.URLTemplateType#getResourceType <em>Resource Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetResourceType()
     * @see #getResourceType()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wmts._1.URLTemplateType#getResourceType <em>Resource Type</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getURLTemplateType_Template()
     * @model dataType="net.opengis.wmts._1.TemplateType" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.URLTemplateType#getTemplate <em>Template</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
