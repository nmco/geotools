 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixSetLinkTypeImpl#getTileMatrixSet <em>Tile Matrix Set</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixSetLinkTypeImpl#getTileMatrixSetLimits <em>Tile Matrix Set Limits</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TileMatrixSetLinkTypeImpl extends MinimalEObjectImpl.Container implements TileMatrixSetLinkType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.TILE_MATRIX_SET_LINK_TYPE;
    }
    ...
    public void setTileMatrixSet(String newTileMatrixSet) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET, oldTileMatrixSet, tileMatrixSet));
    }
    ...
    public NotificationChain basicSetTileMatrixSetLimits(TileMatrixSetLimitsType newTileMatrixSetLimits, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET_LIMITS, oldTileMatrixSetLimits, newTileMatrixSetLimits);
    ...
    public void setTileMatrixSetLimits(TileMatrixSetLimitsType newTileMatrixSetLimits) {
        if (newTileMatrixSetLimits != tileMatrixSetLimits) {
            ...
            if (tileMatrixSetLimits != null)
                msgs = ((InternalEObject)tileMatrixSetLimits).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - wmts11Package.TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET_LIMITS, null, msgs);
            if (newTileMatrixSetLimits != null)
                msgs = ((InternalEObject)newTileMatrixSetLimits).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - wmts11Package.TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET_LIMITS, null, msgs);
            msgs = basicSetTileMatrixSetLimits(newTileMatrixSetLimits, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET_LIMITS, newTileMatrixSetLimits, newTileMatrixSetLimits));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wmts11Package.TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET_LIMITS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wmts11Package.TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET:
