 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts._1.TileMatrixSetLinkType#getTileMatrixSet <em>Tile Matrix Set</em>}</li>
 *   <li>{@link net.opengis.wmts._1.TileMatrixSetLinkType#getTileMatrixSetLimits <em>Tile Matrix Set Limits</em>}</li>
 * </ul>
 *
 * @see net.opengis.wmts._1.wmts11Package#getTileMatrixSetLinkType()
...
public interface TileMatrixSetLinkType extends EObject {
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixSetLinkType_TileMatrixSet()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TileMatrixSetLinkType#getTileMatrixSet <em>Tile Matrix Set</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixSetLinkType_TileMatrixSetLimits()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TileMatrixSetLinkType#getTileMatrixSetLimits <em>Tile Matrix Set Limits</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
