 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.TileMatrixSetLimitsTypeImpl#getTileMatrixLimits <em>Tile Matrix Limits</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TileMatrixSetLimitsTypeImpl extends MinimalEObjectImpl.Container implements TileMatrixSetLimitsType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.TILE_MATRIX_SET_LIMITS_TYPE;
    }
    ...
    public EList<TileMatrixLimitsType> getTileMatrixLimits() {
        if (tileMatrixLimits == null) {
            tileMatrixLimits = new EObjectContainmentEList<TileMatrixLimitsType>(TileMatrixLimitsType.class, this, wmts11Package.TILE_MATRIX_SET_LIMITS_TYPE__TILE_MATRIX_LIMITS);
        }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wmts11Package.TILE_MATRIX_SET_LIMITS_TYPE__TILE_MATRIX_LIMITS:
