 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts._1.CapabilitiesType#getContents <em>Contents</em>}</li>
 *   <li>{@link net.opengis.wmts._1.CapabilitiesType#getThemes <em>Themes</em>}</li>
 *   <li>{@link net.opengis.wmts._1.CapabilitiesType#getWSDL <em>WSDL</em>}</li>
 *   <li>{@link net.opengis.wmts._1.CapabilitiesType#getServiceMetadataURL <em>Service Metadata URL</em>}</li>
 * </ul>
 *
 * @see net.opengis.wmts._1.wmts11Package#getCapabilitiesType()
...
public interface CapabilitiesType extends CapabilitiesBaseType {
     ...
     * @see net.opengis.wmts._1.wmts11Package#getCapabilitiesType_Contents()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.CapabilitiesType#getContents <em>Contents</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link net.opengis.wmts._1.ThemesType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * 
     ...
     * @see net.opengis.wmts._1.wmts11Package#getCapabilitiesType_Themes()
     * @model containment="true"
     ...
     * @see net.opengis.wmts._1.wmts11Package#getCapabilitiesType_WSDL()
     * @model containment="true"
     ...
     * @see net.opengis.wmts._1.wmts11Package#getCapabilitiesType_ServiceMetadataURL()
     * @model containment="true"
