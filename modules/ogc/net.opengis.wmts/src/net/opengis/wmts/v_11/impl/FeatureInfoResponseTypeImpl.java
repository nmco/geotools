 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.FeatureInfoResponseTypeImpl#getFeatureCollectionGroup <em>Feature Collection Group</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.FeatureInfoResponseTypeImpl#getFeatureCollection <em>Feature Collection</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.FeatureInfoResponseTypeImpl#getTextPayload <em>Text Payload</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.FeatureInfoResponseTypeImpl#getBinaryPayload <em>Binary Payload</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.FeatureInfoResponseTypeImpl#getAnyContent <em>Any Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureInfoResponseTypeImpl extends MinimalEObjectImpl.Container implements FeatureInfoResponseType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.FEATURE_INFO_RESPONSE_TYPE;
    }
    ...
    public FeatureMap getFeatureCollectionGroup() {
        if (featureCollectionGroup == null) {
            featureCollectionGroup = new BasicFeatureMap(this, wmts11Package.FEATURE_INFO_RESPONSE_TYPE__FEATURE_COLLECTION_GROUP);
        }
    ...
    public AbstractFeatureCollectionType getFeatureCollection() {
        return (AbstractFeatureCollectionType)getFeatureCollectionGroup().get(wmts11Package.Literals.FEATURE_INFO_RESPONSE_TYPE__FEATURE_COLLECTION, true);
    }
    ...
    public NotificationChain basicSetFeatureCollection(AbstractFeatureCollectionType newFeatureCollection, NotificationChain msgs) {
        return ((FeatureMap.Internal)getFeatureCollectionGroup()).basicAdd(wmts11Package.Literals.FEATURE_INFO_RESPONSE_TYPE__FEATURE_COLLECTION, newFeatureCollection, msgs);
    }
    ...
    public NotificationChain basicSetTextPayload(TextPayloadType newTextPayload, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, wmts11Package.FEATURE_INFO_RESPONSE_TYPE__TEXT_PAYLOAD, oldTextPayload, newTextPayload);
    ...
    public void setTextPayload(TextPayloadType newTextPayload) {
        if (newTextPayload != textPayload) {
            ...
            if (textPayload != null)
                msgs = ((InternalEObject)textPayload).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - wmts11Package.FEATURE_INFO_RESPONSE_TYPE__TEXT_PAYLOAD, null, msgs);
            if (newTextPayload != null)
                msgs = ((InternalEObject)newTextPayload).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - wmts11Package.FEATURE_INFO_RESPONSE_TYPE__TEXT_PAYLOAD, null, msgs);
            msgs = basicSetTextPayload(newTextPayload, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.FEATURE_INFO_RESPONSE_TYPE__TEXT_PAYLOAD, newTextPayload, newTextPayload));
    }
    ...
    public NotificationChain basicSetBinaryPayload(BinaryPayloadType newBinaryPayload, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, wmts11Package.FEATURE_INFO_RESPONSE_TYPE__BINARY_PAYLOAD, oldBinaryPayload, newBinaryPayload);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setBinaryPayload(BinaryPayloadType newBinaryPayload) {
        if (newBinaryPayload != binaryPayload) {
            ...
            if (binaryPayload != null)
                msgs = ((InternalEObject)binaryPayload).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - wmts11Package.FEATURE_INFO_RESPONSE_TYPE__BINARY_PAYLOAD, null, msgs);
            if (newBinaryPayload != null)
                msgs = ((InternalEObject)newBinaryPayload).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - wmts11Package.FEATURE_INFO_RESPONSE_TYPE__BINARY_PAYLOAD, null, msgs);
            msgs = basicSetBinaryPayload(newBinaryPayload, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.FEATURE_INFO_RESPONSE_TYPE__BINARY_PAYLOAD, newBinaryPayload, newBinaryPayload));
    }
    ...
    public NotificationChain basicSetAnyContent(EObject newAnyContent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, wmts11Package.FEATURE_INFO_RESPONSE_TYPE__ANY_CONTENT, oldAnyContent, newAnyContent);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setAnyContent(EObject newAnyContent) {
        if (newAnyContent != anyContent) {
            NotificationChain msgs = null;
            if (anyContent != null)
                msgs = ((InternalEObject)anyContent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - wmts11Package.FEATURE_INFO_RESPONSE_TYPE__ANY_CONTENT, null, msgs);
            if (newAnyContent != null)
                msgs = ((InternalEObject)newAnyContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - wmts11Package.FEATURE_INFO_RESPONSE_TYPE__ANY_CONTENT, null, msgs);
            msgs = basicSetAnyContent(newAnyContent, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.FEATURE_INFO_RESPONSE_TYPE__ANY_CONTENT, newAnyContent, newAnyContent));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wmts11Package.FEATURE_INFO_RESPONSE_TYPE__FEATURE_COLLECTION_GROUP:
                return ((InternalEList<?>)getFeatureCollectionGroup()).basicRemove(otherEnd, msgs);
            case wmts11Package.FEATURE_INFO_RESPONSE_TYPE__FEATURE_COLLECTION:
                return basicSetFeatureCollection(null, msgs);
            case wmts11Package.FEATURE_INFO_RESPONSE_TYPE__TEXT_PAYLOAD:
                return basicSetTextPayload(null, msgs);
            case wmts11Package.FEATURE_INFO_RESPONSE_TYPE__BINARY_PAYLOAD:
                return basicSetBinaryPayload(null, msgs);
            case wmts11Package.FEATURE_INFO_RESPONSE_TYPE__ANY_CONTENT:
