 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts._1.TileMatrixLimitsType#getTileMatrix <em>Tile Matrix</em>}</li>
 *   <li>{@link net.opengis.wmts._1.TileMatrixLimitsType#getMinTileRow <em>Min Tile Row</em>}</li>
 *   <li>{@link net.opengis.wmts._1.TileMatrixLimitsType#getMaxTileRow <em>Max Tile Row</em>}</li>
 *   <li>{@link net.opengis.wmts._1.TileMatrixLimitsType#getMinTileCol <em>Min Tile Col</em>}</li>
 *   <li>{@link net.opengis.wmts._1.TileMatrixLimitsType#getMaxTileCol <em>Max Tile Col</em>}</li>
 * </ul>
 *
 * @see net.opengis.wmts._1.wmts11Package#getTileMatrixLimitsType()
...
public interface TileMatrixLimitsType extends EObject {
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixLimitsType_TileMatrix()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TileMatrixLimitsType#getTileMatrix <em>Tile Matrix</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixLimitsType_MinTileRow()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TileMatrixLimitsType#getMinTileRow <em>Min Tile Row</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixLimitsType_MaxTileRow()
     * @model dataType="org.eclipse.emf.ecore.xml.type.PositiveInteger" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TileMatrixLimitsType#getMaxTileRow <em>Max Tile Row</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixLimitsType_MinTileCol()
     * @model dataType="org.eclipse.emf.ecore.xml.type.PositiveInteger" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TileMatrixLimitsType#getMinTileCol <em>Min Tile Col</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getTileMatrixLimitsType_MaxTileCol()
     * @model dataType="org.eclipse.emf.ecore.xml.type.PositiveInteger" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.TileMatrixLimitsType#getMaxTileCol <em>Max Tile Col</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
