 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.CapabilitiesTypeImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.CapabilitiesTypeImpl#getThemes <em>Themes</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.CapabilitiesTypeImpl#getWSDL <em>WSDL</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.CapabilitiesTypeImpl#getServiceMetadataURL <em>Service Metadata URL</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CapabilitiesTypeImpl extends CapabilitiesBaseTypeImpl implements CapabilitiesType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.CAPABILITIES_TYPE;
    }
    ...
    public NotificationChain basicSetContents(ContentsType newContents, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, wmts11Package.CAPABILITIES_TYPE__CONTENTS, oldContents, newContents);
    ...
    public void setContents(ContentsType newContents) {
        if (newContents != contents) {
            ...
            if (contents != null)
                msgs = ((InternalEObject)contents).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - wmts11Package.CAPABILITIES_TYPE__CONTENTS, null, msgs);
            if (newContents != null)
                msgs = ((InternalEObject)newContents).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - wmts11Package.CAPABILITIES_TYPE__CONTENTS, null, msgs);
            msgs = basicSetContents(newContents, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.CAPABILITIES_TYPE__CONTENTS, newContents, newContents));
    }
    ...
    public EList<ThemesType> getThemes() {
        if (themes == null) {
            themes = new EObjectContainmentEList<ThemesType>(ThemesType.class, this, wmts11Package.CAPABILITIES_TYPE__THEMES);
        }
        return themes;
    }
    ...
    public EList<OnlineResourceType> getWSDL() {
        if (wSDL == null) {
            wSDL = new EObjectContainmentEList<OnlineResourceType>(OnlineResourceType.class, this, wmts11Package.CAPABILITIES_TYPE__WSDL);
        }
        return wSDL;
    }
    ...
    public EList<OnlineResourceType> getServiceMetadataURL() {
        if (serviceMetadataURL == null) {
            serviceMetadataURL = new EObjectContainmentEList<OnlineResourceType>(OnlineResourceType.class, this, wmts11Package.CAPABILITIES_TYPE__SERVICE_METADATA_URL);
        }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wmts11Package.CAPABILITIES_TYPE__CONTENTS:
                return basicSetContents(null, msgs);
            case wmts11Package.CAPABILITIES_TYPE__THEMES:
                return ((InternalEList<?>)getThemes()).basicRemove(otherEnd, msgs);
            case wmts11Package.CAPABILITIES_TYPE__WSDL:
                return ((InternalEList<?>)getWSDL()).basicRemove(otherEnd, msgs);
            case wmts11Package.CAPABILITIES_TYPE__SERVICE_METADATA_URL:
