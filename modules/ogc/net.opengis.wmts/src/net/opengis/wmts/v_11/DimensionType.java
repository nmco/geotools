 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts._1.DimensionType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wmts._1.DimensionType#getUOM <em>UOM</em>}</li>
 *   <li>{@link net.opengis.wmts._1.DimensionType#getUnitSymbol <em>Unit Symbol</em>}</li>
 *   <li>{@link net.opengis.wmts._1.DimensionType#getDefault <em>Default</em>}</li>
 *   <li>{@link net.opengis.wmts._1.DimensionType#isCurrent <em>Current</em>}</li>
 *   <li>{@link net.opengis.wmts._1.DimensionType#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see net.opengis.wmts._1.wmts11Package#getDimensionType()
...
public interface DimensionType extends DescriptionType {
     ...
     * @see net.opengis.wmts._1.wmts11Package#getDimensionType_Identifier()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.DimensionType#getIdentifier <em>Identifier</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getDimensionType_UOM()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.DimensionType#getUOM <em>UOM</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getDimensionType_UnitSymbol()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.DimensionType#getUnitSymbol <em>Unit Symbol</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getDimensionType_Default()
     * @model dataType="org.eclipse.emf.ecore.xml.type.String"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.DimensionType#getDefault <em>Default</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getDimensionType_Current()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.DimensionType#isCurrent <em>Current</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wmts._1.DimensionType#isCurrent <em>Current</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetCurrent()
     * @see #isCurrent()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wmts._1.DimensionType#isCurrent <em>Current</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getDimensionType_Value()
