 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.TextPayloadTypeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.TextPayloadTypeImpl#getTextContent <em>Text Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextPayloadTypeImpl extends MinimalEObjectImpl.Container implements TextPayloadType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.TEXT_PAYLOAD_TYPE;
    }
    ...
    public void setFormat(String newFormat) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TEXT_PAYLOAD_TYPE__FORMAT, oldFormat, format));
    }
    ...
    public void setTextContent(String newTextContent) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.TEXT_PAYLOAD_TYPE__TEXT_CONTENT, oldTextContent, textContent));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wmts11Package.TEXT_PAYLOAD_TYPE__FORMAT:
                return getFormat();
            case wmts11Package.TEXT_PAYLOAD_TYPE__TEXT_CONTENT:
