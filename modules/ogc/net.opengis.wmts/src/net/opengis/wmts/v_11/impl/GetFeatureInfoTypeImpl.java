 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetFeatureInfoTypeImpl#getGetTile <em>Get Tile</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetFeatureInfoTypeImpl#getJ <em>J</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetFeatureInfoTypeImpl#getI <em>I</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetFeatureInfoTypeImpl#getInfoFormat <em>Info Format</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetFeatureInfoTypeImpl#getService <em>Service</em>}</li>
 *   <li>{@link net.opengis.wmts.v_11.impl.GetFeatureInfoTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetFeatureInfoTypeImpl extends MinimalEObjectImpl.Container implements GetFeatureInfoType {
    ...
    protected EClass eStaticClass() {
        return wmts11Package.Literals.GET_FEATURE_INFO_TYPE;
    }
    ...
    public NotificationChain basicSetGetTile(GetTileType newGetTile, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, wmts11Package.GET_FEATURE_INFO_TYPE__GET_TILE, oldGetTile, newGetTile);
    ...
    public void setGetTile(GetTileType newGetTile) {
        if (newGetTile != getTile) {
            ...
            if (getTile != null)
                msgs = ((InternalEObject)getTile).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - wmts11Package.GET_FEATURE_INFO_TYPE__GET_TILE, null, msgs);
            if (newGetTile != null)
                msgs = ((InternalEObject)newGetTile).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - wmts11Package.GET_FEATURE_INFO_TYPE__GET_TILE, null, msgs);
            msgs = basicSetGetTile(newGetTile, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_FEATURE_INFO_TYPE__GET_TILE, newGetTile, newGetTile));
    }
    ...
    public void setJ(BigInteger newJ) {
        ...
        j = newJ;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_FEATURE_INFO_TYPE__J, oldJ, j));
    }
    ...
    public void setI(BigInteger newI) {
        ...
        i = newI;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_FEATURE_INFO_TYPE__I, oldI, i));
    }
    ...
    public void setInfoFormat(String newInfoFormat) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_FEATURE_INFO_TYPE__INFO_FORMAT, oldInfoFormat, infoFormat));
    }
    ...
    public void setService(String newService) {
        ...
        serviceESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_FEATURE_INFO_TYPE__SERVICE, oldService, service, !oldServiceESet));
    }
    ...
    public void unsetService() {
        ...
        serviceESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, wmts11Package.GET_FEATURE_INFO_TYPE__SERVICE, oldService, SERVICE_EDEFAULT, oldServiceESet));
    }
    ...
    public void setVersion(String newVersion) {
        ...
        versionESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wmts11Package.GET_FEATURE_INFO_TYPE__VERSION, oldVersion, version, !oldVersionESet));
    }
    ...
    public void unsetVersion() {
        ...
        versionESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, wmts11Package.GET_FEATURE_INFO_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wmts11Package.GET_FEATURE_INFO_TYPE__GET_TILE:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wmts11Package.GET_FEATURE_INFO_TYPE__GET_TILE:
                return getGetTile();
            case wmts11Package.GET_FEATURE_INFO_TYPE__J:
                return getJ();
            case wmts11Package.GET_FEATURE_INFO_TYPE__I:
                return getI();
            case wmts11Package.GET_FEATURE_INFO_TYPE__INFO_FORMAT:
                return getInfoFormat();
            case wmts11Package.GET_FEATURE_INFO_TYPE__SERVICE:
                return getService();
            case wmts11Package.GET_FEATURE_INFO_TYPE__VERSION:
                return getVersion();
        }
