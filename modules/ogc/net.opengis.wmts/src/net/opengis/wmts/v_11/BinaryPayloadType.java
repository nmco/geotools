 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wmts._1.BinaryPayloadType#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wmts._1.BinaryPayloadType#getBinaryContent <em>Binary Content</em>}</li>
 * </ul>
 *
 * @see net.opengis.wmts._1.wmts11Package#getBinaryPayloadType()
...
public interface BinaryPayloadType extends EObject {
     ...
     * @see net.opengis.wmts._1.wmts11Package#getBinaryPayloadType_Format()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.BinaryPayloadType#getFormat <em>Format</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wmts._1.wmts11Package#getBinaryPayloadType_BinaryContent()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wmts._1.BinaryPayloadType#getBinaryContent <em>Binary Content</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
