 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.EnvelopeType#getLowerCorner <em>Lower Corner</em>}</li>
 *   <li>{@link net.opengis.gml.EnvelopeType#getUpperCorner <em>Upper Corner</em>}</li>
 *   <li>{@link net.opengis.gml.EnvelopeType#getCoord <em>Coord</em>}</li>
 *   <li>{@link net.opengis.gml.EnvelopeType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.EnvelopeType#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link net.opengis.gml.EnvelopeType#getAxisLabels <em>Axis Labels</em>}</li>
 *   <li>{@link net.opengis.gml.EnvelopeType#getSrsDimension <em>Srs Dimension</em>}</li>
 *   <li>{@link net.opengis.gml.EnvelopeType#getSrsName <em>Srs Name</em>}</li>
 *   <li>{@link net.opengis.gml.EnvelopeType#getUomLabels <em>Uom Labels</em>}</li>
 * </ul>
 *
...
public interface EnvelopeType extends EObject {
     ...
     * @see net.opengis.gml.GmlPackage#getEnvelopeType_LowerCorner()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.EnvelopeType#getLowerCorner <em>Lower Corner</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getEnvelopeType_UpperCorner()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.EnvelopeType#getUpperCorner <em>Upper Corner</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getEnvelopeType_Coord()
     ...
     * @see net.opengis.gml.GmlPackage#getEnvelopeType_Coordinates()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.EnvelopeType#getCoordinates <em>Coordinates</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getEnvelopeType_AxisLabels()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.EnvelopeType#getAxisLabels <em>Axis Labels</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getEnvelopeType_SrsDimension()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.EnvelopeType#getSrsDimension <em>Srs Dimension</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getEnvelopeType_SrsName()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.EnvelopeType#getSrsName <em>Srs Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getEnvelopeType_UomLabels()
     * @model dataType="net.opengis.gml.NCNameList" many="false"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.EnvelopeType#getUomLabels <em>Uom Labels</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
