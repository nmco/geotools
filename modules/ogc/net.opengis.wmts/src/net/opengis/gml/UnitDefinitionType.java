 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.UnitDefinitionType#getQuantityType <em>Quantity Type</em>}</li>
 *   <li>{@link net.opengis.gml.UnitDefinitionType#getCatalogSymbol <em>Catalog Symbol</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getUnitDefinitionType()
...
public interface UnitDefinitionType extends DefinitionType {
     ...
     * @see net.opengis.gml.GmlPackage#getUnitDefinitionType_QuantityType()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.UnitDefinitionType#getQuantityType <em>Quantity Type</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getUnitDefinitionType_CatalogSymbol()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.UnitDefinitionType#getCatalogSymbol <em>Catalog Symbol</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
