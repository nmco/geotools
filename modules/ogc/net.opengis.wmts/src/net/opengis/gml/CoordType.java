 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.CoordType#getX <em>X</em>}</li>
 *   <li>{@link net.opengis.gml.CoordType#getY <em>Y</em>}</li>
 *   <li>{@link net.opengis.gml.CoordType#getZ <em>Z</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getCoordType()
...
public interface CoordType extends EObject {
     ...
     * @see #setX(BigDecimal)
     * @see net.opengis.gml.GmlPackage#getCoordType_X()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.CoordType#getX <em>X</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setY(BigDecimal)
     * @see net.opengis.gml.GmlPackage#getCoordType_Y()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.CoordType#getY <em>Y</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setZ(BigDecimal)
     * @see net.opengis.gml.GmlPackage#getCoordType_Z()
     * @model dataType="org.eclipse.emf.ecore.xml.type.Decimal"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.CoordType#getZ <em>Z</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
