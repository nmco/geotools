 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.ConversionToPreferredUnitType#getFactor <em>Factor</em>}</li>
 *   <li>{@link net.opengis.gml.ConversionToPreferredUnitType#getFormula <em>Formula</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getConversionToPreferredUnitType()
...
public interface ConversionToPreferredUnitType extends UnitOfMeasureType {
     ...
     * @see net.opengis.gml.GmlPackage#getConversionToPreferredUnitType_Factor()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ConversionToPreferredUnitType#getFactor <em>Factor</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.ConversionToPreferredUnitType#getFactor <em>Factor</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetFactor()
     * @see #getFactor()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.ConversionToPreferredUnitType#getFactor <em>Factor</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getConversionToPreferredUnitType_Formula()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ConversionToPreferredUnitType#getFormula <em>Formula</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
