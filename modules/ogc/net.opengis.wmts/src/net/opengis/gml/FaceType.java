 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.FaceType#getDirectedEdge <em>Directed Edge</em>}</li>
 *   <li>{@link net.opengis.gml.FaceType#getDirectedTopoSolid <em>Directed Topo Solid</em>}</li>
 *   <li>{@link net.opengis.gml.FaceType#getSurfaceProperty <em>Surface Property</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getFaceType()
...
public interface FaceType extends AbstractTopoPrimitiveType {
     ...
     * @see net.opengis.gml.GmlPackage#getFaceType_DirectedEdge()
     ...
     * @see net.opengis.gml.GmlPackage#getFaceType_DirectedTopoSolid()
     ...
     * @see net.opengis.gml.GmlPackage#getFaceType_SurfaceProperty()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.FaceType#getSurfaceProperty <em>Surface Property</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
