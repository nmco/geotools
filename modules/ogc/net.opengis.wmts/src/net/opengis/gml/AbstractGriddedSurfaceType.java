 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.AbstractGriddedSurfaceType#getRow <em>Row</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractGriddedSurfaceType#getRows <em>Rows</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractGriddedSurfaceType#getColumns <em>Columns</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getAbstractGriddedSurfaceType()
...
public interface AbstractGriddedSurfaceType extends AbstractParametricCurveSurfaceType {
     ...
     * The list contents are of type {@link net.opengis.gml.RowType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractGriddedSurfaceType_Row()
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractGriddedSurfaceType_Rows()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractGriddedSurfaceType#getRows <em>Rows</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractGriddedSurfaceType_Columns()
     * @model dataType="org.eclipse.emf.ecore.xml.type.Integer"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractGriddedSurfaceType#getColumns <em>Columns</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
