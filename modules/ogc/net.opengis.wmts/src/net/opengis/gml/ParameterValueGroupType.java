 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.ParameterValueGroupType#getIncludesValue <em>Includes Value</em>}</li>
 *   <li>{@link net.opengis.gml.ParameterValueGroupType#getValuesOfGroup <em>Values Of Group</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getParameterValueGroupType()
...
public interface ParameterValueGroupType extends AbstractGeneralParameterValueType {
     ...
     * The list contents are of type {@link net.opengis.gml.AbstractGeneralParameterValueType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getParameterValueGroupType_IncludesValue()
     ...
     * @see net.opengis.gml.GmlPackage#getParameterValueGroupType_ValuesOfGroup()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ParameterValueGroupType#getValuesOfGroup <em>Values Of Group</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
