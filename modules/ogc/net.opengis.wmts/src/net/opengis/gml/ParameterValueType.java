 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.ParameterValueType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml.ParameterValueType#getDmsAngleValue <em>Dms Angle Value</em>}</li>
 *   <li>{@link net.opengis.gml.ParameterValueType#getStringValue <em>String Value</em>}</li>
 *   <li>{@link net.opengis.gml.ParameterValueType#getIntegerValue <em>Integer Value</em>}</li>
 *   <li>{@link net.opengis.gml.ParameterValueType#isBooleanValue <em>Boolean Value</em>}</li>
 *   <li>{@link net.opengis.gml.ParameterValueType#getValueList <em>Value List</em>}</li>
 *   <li>{@link net.opengis.gml.ParameterValueType#getIntegerValueList <em>Integer Value List</em>}</li>
 *   <li>{@link net.opengis.gml.ParameterValueType#getValueFile <em>Value File</em>}</li>
 *   <li>{@link net.opengis.gml.ParameterValueType#getValueOfParameter <em>Value Of Parameter</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getParameterValueType()
...
public interface ParameterValueType extends AbstractGeneralParameterValueType {
     ...
     * @see net.opengis.gml.GmlPackage#getParameterValueType_Value()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ParameterValueType#getValue <em>Value</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getParameterValueType_DmsAngleValue()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ParameterValueType#getDmsAngleValue <em>Dms Angle Value</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getParameterValueType_StringValue()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ParameterValueType#getStringValue <em>String Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getParameterValueType_IntegerValue()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ParameterValueType#getIntegerValue <em>Integer Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getParameterValueType_BooleanValue()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ParameterValueType#isBooleanValue <em>Boolean Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.ParameterValueType#isBooleanValue <em>Boolean Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetBooleanValue()
     * @see #isBooleanValue()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.ParameterValueType#isBooleanValue <em>Boolean Value</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getParameterValueType_ValueList()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ParameterValueType#getValueList <em>Value List</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getParameterValueType_IntegerValueList()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ParameterValueType#getIntegerValueList <em>Integer Value List</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getParameterValueType_ValueFile()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ParameterValueType#getValueFile <em>Value File</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getParameterValueType_ValueOfParameter()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ParameterValueType#getValueOfParameter <em>Value Of Parameter</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
