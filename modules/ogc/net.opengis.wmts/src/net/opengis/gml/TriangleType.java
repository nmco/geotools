 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.TriangleType#getExteriorGroup <em>Exterior Group</em>}</li>
 *   <li>{@link net.opengis.gml.TriangleType#getExterior <em>Exterior</em>}</li>
 *   <li>{@link net.opengis.gml.TriangleType#getInterpolation <em>Interpolation</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getTriangleType()
...
public interface TriangleType extends AbstractSurfacePatchType {
     ...
     * @see net.opengis.gml.GmlPackage#getTriangleType_ExteriorGroup()
     ...
     * @see net.opengis.gml.GmlPackage#getTriangleType_Exterior()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.TriangleType#getExterior <em>Exterior</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getTriangleType_Interpolation()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.TriangleType#getInterpolation <em>Interpolation</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.TriangleType#getInterpolation <em>Interpolation</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetInterpolation()
     * @see #getInterpolation()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.TriangleType#getInterpolation <em>Interpolation</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
