 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.ClothoidType#getRefLocation <em>Ref Location</em>}</li>
 *   <li>{@link net.opengis.gml.ClothoidType#getScaleFactor <em>Scale Factor</em>}</li>
 *   <li>{@link net.opengis.gml.ClothoidType#getStartParameter <em>Start Parameter</em>}</li>
 *   <li>{@link net.opengis.gml.ClothoidType#getEndParameter <em>End Parameter</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getClothoidType()
...
public interface ClothoidType extends AbstractCurveSegmentType {
     ...
     * @see net.opengis.gml.GmlPackage#getClothoidType_RefLocation()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ClothoidType#getRefLocation <em>Ref Location</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getClothoidType_ScaleFactor()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ClothoidType#getScaleFactor <em>Scale Factor</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getClothoidType_StartParameter()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ClothoidType#getStartParameter <em>Start Parameter</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.ClothoidType#getStartParameter <em>Start Parameter</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetStartParameter()
     * @see #getStartParameter()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.ClothoidType#getStartParameter <em>Start Parameter</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getClothoidType_EndParameter()
     * @model unsettable="true" dataType="org.eclipse.emf.ecore.xml.type.Double" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ClothoidType#getEndParameter <em>End Parameter</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.ClothoidType#getEndParameter <em>End Parameter</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetEndParameter()
     * @see #getEndParameter()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.ClothoidType#getEndParameter <em>End Parameter</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
