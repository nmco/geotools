 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.TriangleTypeImpl#getExteriorGroup <em>Exterior Group</em>}</li>
 *   <li>{@link net.opengis.gml.impl.TriangleTypeImpl#getExterior <em>Exterior</em>}</li>
 *   <li>{@link net.opengis.gml.impl.TriangleTypeImpl#getInterpolation <em>Interpolation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TriangleTypeImpl extends AbstractSurfacePatchTypeImpl implements TriangleType {
    ...
    public FeatureMap getExteriorGroup() {
        if (exteriorGroup == null) {
            exteriorGroup = new BasicFeatureMap(this, GmlPackage.TRIANGLE_TYPE__EXTERIOR_GROUP);
        }
    ...
    public AbstractRingPropertyType getExterior() {
        return (AbstractRingPropertyType)getExteriorGroup().get(GmlPackage.eINSTANCE.getTriangleType_Exterior(), true);
    }
    ...
    public NotificationChain basicSetExterior(AbstractRingPropertyType newExterior, NotificationChain msgs) {
        return ((FeatureMap.Internal)getExteriorGroup()).basicAdd(GmlPackage.eINSTANCE.getTriangleType_Exterior(), newExterior, msgs);
    }
    ...
    public void setExterior(AbstractRingPropertyType newExterior) {
        ((FeatureMap.Internal)getExteriorGroup()).set(GmlPackage.eINSTANCE.getTriangleType_Exterior(), newExterior);
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case GmlPackage.TRIANGLE_TYPE__EXTERIOR_GROUP:
