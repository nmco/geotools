 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.LabelTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LabelTypeImpl#getLabelExpression <em>Label Expression</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LabelTypeImpl#getTransform <em>Transform</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LabelTypeImpl extends MinimalEObjectImpl.Container implements LabelType {
    ...
    protected EClass eStaticClass() {
        return GmlPackage.eINSTANCE.getLabelType();
    }
    ...
    public FeatureMap getMixed() {
        if (mixed == null) {
            mixed = new BasicFeatureMap(this, GmlPackage.LABEL_TYPE__MIXED);
        }
        return mixed;
    }
    ...
    public EList<String> getLabelExpression() {
        return getMixed().list(GmlPackage.eINSTANCE.getLabelType_LabelExpression());
    }
    ...
    public void setTransform(String newTransform) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.LABEL_TYPE__TRANSFORM, oldTransform, transform));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case GmlPackage.LABEL_TYPE__MIXED:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case GmlPackage.LABEL_TYPE__LABEL_EXPRESSION:
                return getLabelExpression();
            case GmlPackage.LABEL_TYPE__TRANSFORM:
                return getTransform();
        }
