 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.ArcStringByBulgeTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ArcStringByBulgeTypeImpl#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ArcStringByBulgeTypeImpl#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ArcStringByBulgeTypeImpl#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ArcStringByBulgeTypeImpl#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ArcStringByBulgeTypeImpl#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ArcStringByBulgeTypeImpl#getBulge <em>Bulge</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ArcStringByBulgeTypeImpl#getNormal <em>Normal</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ArcStringByBulgeTypeImpl#getInterpolation <em>Interpolation</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ArcStringByBulgeTypeImpl#getNumArc <em>Num Arc</em>}</li>
 * </ul>
 *
 * @generated
 */
