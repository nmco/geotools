 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.MetaDataPropertyTypeImpl#getAny <em>Any</em>}</li>
...
public class MetaDataPropertyTypeImpl extends MinimalEObjectImpl.Container implements MetaDataPropertyType {
    ...
    public FeatureMap getAny() {
        if (any == null) {
            any = new BasicFeatureMap(this, GmlPackage.META_DATA_PROPERTY_TYPE__ANY);
        }
        return any;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case GmlPackage.META_DATA_PROPERTY_TYPE__ANY:
