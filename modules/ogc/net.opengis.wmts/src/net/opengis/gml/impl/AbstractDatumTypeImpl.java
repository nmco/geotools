 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.AbstractDatumTypeImpl#getDatumID <em>Datum ID</em>}</li>
 *   <li>{@link net.opengis.gml.impl.AbstractDatumTypeImpl#getRemarks <em>Remarks</em>}</li>
 *   <li>{@link net.opengis.gml.impl.AbstractDatumTypeImpl#getAnchorPoint <em>Anchor Point</em>}</li>
 *   <li>{@link net.opengis.gml.impl.AbstractDatumTypeImpl#getRealizationEpoch <em>Realization Epoch</em>}</li>
 *   <li>{@link net.opengis.gml.impl.AbstractDatumTypeImpl#getValidArea <em>Valid Area</em>}</li>
 *   <li>{@link net.opengis.gml.impl.AbstractDatumTypeImpl#getScope <em>Scope</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractDatumTypeImpl extends AbstractDatumBaseTypeImpl implements AbstractDatumType {
    ...
    public EList<IdentifierType> getDatumID() {
        if (datumID == null) {
            datumID = new EObjectContainmentEList<IdentifierType>(IdentifierType.class, this, GmlPackage.ABSTRACT_DATUM_TYPE__DATUM_ID);
        }
        return datumID;
    }
    ...
    public NotificationChain basicSetRemarks(StringOrRefType newRemarks, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_DATUM_TYPE__REMARKS, oldRemarks, newRemarks);
    ...
    public void setRemarks(StringOrRefType newRemarks) {
        if (newRemarks != remarks) {
            ...
            if (remarks != null)
                msgs = ((InternalEObject)remarks).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ABSTRACT_DATUM_TYPE__REMARKS, null, msgs);
            if (newRemarks != null)
                msgs = ((InternalEObject)newRemarks).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ABSTRACT_DATUM_TYPE__REMARKS, null, msgs);
            msgs = basicSetRemarks(newRemarks, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_DATUM_TYPE__REMARKS, newRemarks, newRemarks));
    }
    ...
    public NotificationChain basicSetAnchorPoint(CodeType newAnchorPoint, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_DATUM_TYPE__ANCHOR_POINT, oldAnchorPoint, newAnchorPoint);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setAnchorPoint(CodeType newAnchorPoint) {
        if (newAnchorPoint != anchorPoint) {
            NotificationChain msgs = null;
            if (anchorPoint != null)
                msgs = ((InternalEObject)anchorPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ABSTRACT_DATUM_TYPE__ANCHOR_POINT, null, msgs);
            if (newAnchorPoint != null)
                msgs = ((InternalEObject)newAnchorPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ABSTRACT_DATUM_TYPE__ANCHOR_POINT, null, msgs);
            msgs = basicSetAnchorPoint(newAnchorPoint, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_DATUM_TYPE__ANCHOR_POINT, newAnchorPoint, newAnchorPoint));
    }
    ...
    public NotificationChain basicSetValidArea(ExtentType newValidArea, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_DATUM_TYPE__VALID_AREA, oldValidArea, newValidArea);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setValidArea(ExtentType newValidArea) {
        if (newValidArea != validArea) {
            NotificationChain msgs = null;
            if (validArea != null)
                msgs = ((InternalEObject)validArea).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ABSTRACT_DATUM_TYPE__VALID_AREA, null, msgs);
            if (newValidArea != null)
                msgs = ((InternalEObject)newValidArea).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ABSTRACT_DATUM_TYPE__VALID_AREA, null, msgs);
            msgs = basicSetValidArea(newValidArea, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_DATUM_TYPE__VALID_AREA, newValidArea, newValidArea));
    }
    ...
    public void setScope(String newScope) {
        ...
        scope = newScope;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_DATUM_TYPE__SCOPE, oldScope, scope));
    }
