 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.AbstractTopoPrimitiveTypeImpl#getIsolated <em>Isolated</em>}</li>
 *   <li>{@link net.opengis.gml.impl.AbstractTopoPrimitiveTypeImpl#getContainer <em>Container</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractTopoPrimitiveTypeImpl extends AbstractTopologyTypeImpl implements AbstractTopoPrimitiveType {
    ...
    public EList<IsolatedPropertyType> getIsolated() {
        if (isolated == null) {
            isolated = new EObjectContainmentEList<IsolatedPropertyType>(IsolatedPropertyType.class, this, GmlPackage.ABSTRACT_TOPO_PRIMITIVE_TYPE__ISOLATED);
        }
        return isolated;
    }
    ...
    public NotificationChain basicSetContainer(ContainerPropertyType newContainer, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_TOPO_PRIMITIVE_TYPE__CONTAINER, oldContainer, newContainer);
    ...
    public void setContainer(ContainerPropertyType newContainer) {
        if (newContainer != container) {
            ...
            if (container != null)
                msgs = ((InternalEObject)container).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ABSTRACT_TOPO_PRIMITIVE_TYPE__CONTAINER, null, msgs);
            if (newContainer != null)
                msgs = ((InternalEObject)newContainer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ABSTRACT_TOPO_PRIMITIVE_TYPE__CONTAINER, null, msgs);
            msgs = basicSetContainer(newContainer, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_TOPO_PRIMITIVE_TYPE__CONTAINER, newContainer, newContainer));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case GmlPackage.ABSTRACT_TOPO_PRIMITIVE_TYPE__ISOLATED:
                return ((InternalEList<?>)getIsolated()).basicRemove(otherEnd, msgs);
            case GmlPackage.ABSTRACT_TOPO_PRIMITIVE_TYPE__CONTAINER:
