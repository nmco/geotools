 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.TimeCalendarEraTypeImpl#getReferenceEvent <em>Reference Event</em>}</li>
 *   <li>{@link net.opengis.gml.impl.TimeCalendarEraTypeImpl#getReferenceDate <em>Reference Date</em>}</li>
 *   <li>{@link net.opengis.gml.impl.TimeCalendarEraTypeImpl#getJulianReference <em>Julian Reference</em>}</li>
 *   <li>{@link net.opengis.gml.impl.TimeCalendarEraTypeImpl#getEpochOfUse <em>Epoch Of Use</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeCalendarEraTypeImpl extends DefinitionTypeImpl implements TimeCalendarEraType {
    ...
    public void setReferenceDate(XMLGregorianCalendar newReferenceDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.TIME_CALENDAR_ERA_TYPE__REFERENCE_DATE, oldReferenceDate, referenceDate, !oldReferenceDateESet));
    }
    ...
    public void unsetReferenceDate() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.TIME_CALENDAR_ERA_TYPE__REFERENCE_DATE, oldReferenceDate, REFERENCE_DATE_EDEFAULT, oldReferenceDateESet));
    }
