 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.DomainSetTypeImpl#getGeometryGroup <em>Geometry Group</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DomainSetTypeImpl#getGeometry <em>Geometry</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DomainSetTypeImpl#getTimeObjectGroup <em>Time Object Group</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DomainSetTypeImpl#getTimeObject <em>Time Object</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DomainSetTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DomainSetTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DomainSetTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DomainSetTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DomainSetTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DomainSetTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DomainSetTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DomainSetTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainSetTypeImpl extends MinimalEObjectImpl.Container implements DomainSetType {
    ...
    public FeatureMap getGeometryGroup() {
        if (geometryGroup == null) {
            geometryGroup = new BasicFeatureMap(this, GmlPackage.DOMAIN_SET_TYPE__GEOMETRY_GROUP);
        }
    ...
    public AbstractGeometryType getGeometry() {
        return (AbstractGeometryType)getGeometryGroup().get(GmlPackage.eINSTANCE.getDomainSetType_Geometry(), true);
    }
    ...
    public NotificationChain basicSetGeometry(AbstractGeometryType newGeometry, NotificationChain msgs) {
        return ((FeatureMap.Internal)getGeometryGroup()).basicAdd(GmlPackage.eINSTANCE.getDomainSetType_Geometry(), newGeometry, msgs);
    }
    ...
    public FeatureMap getTimeObjectGroup() {
        if (timeObjectGroup == null) {
            timeObjectGroup = new BasicFeatureMap(this, GmlPackage.DOMAIN_SET_TYPE__TIME_OBJECT_GROUP);
        }
    ...
    public AbstractTimeObjectType getTimeObject() {
        return (AbstractTimeObjectType)getTimeObjectGroup().get(GmlPackage.eINSTANCE.getDomainSetType_TimeObject(), true);
    }
    ...
    public NotificationChain basicSetTimeObject(AbstractTimeObjectType newTimeObject, NotificationChain msgs) {
        return ((FeatureMap.Internal)getTimeObjectGroup()).basicAdd(GmlPackage.eINSTANCE.getDomainSetType_TimeObject(), newTimeObject, msgs);
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case GmlPackage.DOMAIN_SET_TYPE__GEOMETRY:
            ...
            case GmlPackage.DOMAIN_SET_TYPE__TIME_OBJECT:
