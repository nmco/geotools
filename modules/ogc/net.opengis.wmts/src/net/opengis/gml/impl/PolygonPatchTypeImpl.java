 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.PolygonPatchTypeImpl#getExteriorGroup <em>Exterior Group</em>}</li>
 *   <li>{@link net.opengis.gml.impl.PolygonPatchTypeImpl#getExterior <em>Exterior</em>}</li>
 *   <li>{@link net.opengis.gml.impl.PolygonPatchTypeImpl#getInteriorGroup <em>Interior Group</em>}</li>
 *   <li>{@link net.opengis.gml.impl.PolygonPatchTypeImpl#getInterior <em>Interior</em>}</li>
 *   <li>{@link net.opengis.gml.impl.PolygonPatchTypeImpl#getInterpolation <em>Interpolation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PolygonPatchTypeImpl extends AbstractSurfacePatchTypeImpl implements PolygonPatchType {
    ...
    public FeatureMap getExteriorGroup() {
        if (exteriorGroup == null) {
            exteriorGroup = new BasicFeatureMap(this, GmlPackage.POLYGON_PATCH_TYPE__EXTERIOR_GROUP);
        }
    ...
    public AbstractRingPropertyType getExterior() {
        return (AbstractRingPropertyType)getExteriorGroup().get(GmlPackage.eINSTANCE.getPolygonPatchType_Exterior(), true);
    }
    ...
    public NotificationChain basicSetExterior(AbstractRingPropertyType newExterior, NotificationChain msgs) {
        return ((FeatureMap.Internal)getExteriorGroup()).basicAdd(GmlPackage.eINSTANCE.getPolygonPatchType_Exterior(), newExterior, msgs);
    }
    ...
    public void setExterior(AbstractRingPropertyType newExterior) {
        ((FeatureMap.Internal)getExteriorGroup()).set(GmlPackage.eINSTANCE.getPolygonPatchType_Exterior(), newExterior);
    }
    ...
    public FeatureMap getInteriorGroup() {
        if (interiorGroup == null) {
            interiorGroup = new BasicFeatureMap(this, GmlPackage.POLYGON_PATCH_TYPE__INTERIOR_GROUP);
        }
    ...
    public EList<AbstractRingPropertyType> getInterior() {
        return getInteriorGroup().list(GmlPackage.eINSTANCE.getPolygonPatchType_Interior());
    }
