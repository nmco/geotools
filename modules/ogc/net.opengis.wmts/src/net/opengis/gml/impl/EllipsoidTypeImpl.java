 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.EllipsoidTypeImpl#getEllipsoidID <em>Ellipsoid ID</em>}</li>
 *   <li>{@link net.opengis.gml.impl.EllipsoidTypeImpl#getRemarks <em>Remarks</em>}</li>
 *   <li>{@link net.opengis.gml.impl.EllipsoidTypeImpl#getSemiMajorAxis <em>Semi Major Axis</em>}</li>
 *   <li>{@link net.opengis.gml.impl.EllipsoidTypeImpl#getSecondDefiningParameter <em>Second Defining Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EllipsoidTypeImpl extends EllipsoidBaseTypeImpl implements EllipsoidType {
    ...
    public EList<IdentifierType> getEllipsoidID() {
        if (ellipsoidID == null) {
            ellipsoidID = new EObjectContainmentEList<IdentifierType>(IdentifierType.class, this, GmlPackage.ELLIPSOID_TYPE__ELLIPSOID_ID);
        }
        return ellipsoidID;
    }
    ...
    public NotificationChain basicSetRemarks(StringOrRefType newRemarks, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.ELLIPSOID_TYPE__REMARKS, oldRemarks, newRemarks);
    ...
    public void setRemarks(StringOrRefType newRemarks) {
        if (newRemarks != remarks) {
            ...
            if (remarks != null)
                msgs = ((InternalEObject)remarks).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ELLIPSOID_TYPE__REMARKS, null, msgs);
            if (newRemarks != null)
                msgs = ((InternalEObject)newRemarks).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ELLIPSOID_TYPE__REMARKS, null, msgs);
            msgs = basicSetRemarks(newRemarks, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.ELLIPSOID_TYPE__REMARKS, newRemarks, newRemarks));
    }
