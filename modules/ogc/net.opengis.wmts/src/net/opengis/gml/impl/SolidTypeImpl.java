 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.SolidTypeImpl#getExterior <em>Exterior</em>}</li>
 *   <li>{@link net.opengis.gml.impl.SolidTypeImpl#getInterior <em>Interior</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SolidTypeImpl extends AbstractSolidTypeImpl implements SolidType {
    ...
    public EList<SurfacePropertyType> getInterior() {
        if (interior == null) {
            interior = new EObjectContainmentEList<SurfacePropertyType>(SurfacePropertyType.class, this, GmlPackage.SOLID_TYPE__INTERIOR);
        }
        return interior;
    }
