 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getGeometryGroup <em>Geometry Group</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getGeometry <em>Geometry</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getLocationKeyWord <em>Location Key Word</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getLocationString <em>Location String</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getNull <em>Null</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml.impl.LocationPropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocationPropertyTypeImpl extends MinimalEObjectImpl.Container implements LocationPropertyType {
    ...
    public FeatureMap getGeometryGroup() {
        if (geometryGroup == null) {
            geometryGroup = new BasicFeatureMap(this, GmlPackage.LOCATION_PROPERTY_TYPE__GEOMETRY_GROUP);
        }
    ...
    public AbstractGeometryType getGeometry() {
        return (AbstractGeometryType)getGeometryGroup().get(GmlPackage.eINSTANCE.getLocationPropertyType_Geometry(), true);
    }
    ...
    public NotificationChain basicSetGeometry(AbstractGeometryType newGeometry, NotificationChain msgs) {
        return ((FeatureMap.Internal)getGeometryGroup()).basicAdd(GmlPackage.eINSTANCE.getLocationPropertyType_Geometry(), newGeometry, msgs);
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case GmlPackage.LOCATION_PROPERTY_TYPE__GEOMETRY:
