 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.GridCoverageTypeImpl#getGridDomain <em>Grid Domain</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GridCoverageTypeImpl extends AbstractDiscreteCoverageTypeImpl implements GridCoverageType {
    ...
    protected EClass eStaticClass() {
        return GmlPackage.eINSTANCE.getGridCoverageType();
    }
    ...
    public NotificationChain basicSetGridDomain(GridDomainType newGridDomain, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.GRID_COVERAGE_TYPE__GRID_DOMAIN, oldGridDomain, newGridDomain);
    ...
    public void setGridDomain(GridDomainType newGridDomain) {
        if (newGridDomain != gridDomain) {
            ...
            if (gridDomain != null)
                msgs = ((InternalEObject)gridDomain).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.GRID_COVERAGE_TYPE__GRID_DOMAIN, null, msgs);
            if (newGridDomain != null)
                msgs = ((InternalEObject)newGridDomain).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.GRID_COVERAGE_TYPE__GRID_DOMAIN, null, msgs);
            msgs = basicSetGridDomain(newGridDomain, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.GRID_COVERAGE_TYPE__GRID_DOMAIN, newGridDomain, newGridDomain));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case GmlPackage.GRID_COVERAGE_TYPE__GRID_DOMAIN:
