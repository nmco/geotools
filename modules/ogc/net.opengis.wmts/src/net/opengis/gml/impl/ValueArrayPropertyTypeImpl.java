 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getBoolean <em>Boolean</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getCount <em>Count</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getBooleanList <em>Boolean List</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getCategoryList <em>Category List</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getQuantityList <em>Quantity List</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getCountList <em>Count List</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getCategoryExtent <em>Category Extent</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getQuantityExtent <em>Quantity Extent</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getCountExtent <em>Count Extent</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getCompositeValueGroup <em>Composite Value Group</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getCompositeValue <em>Composite Value</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getObjectGroup <em>Object Group</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getObject <em>Object</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ValueArrayPropertyTypeImpl#getNull <em>Null</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueArrayPropertyTypeImpl extends MinimalEObjectImpl.Container implements ValueArrayPropertyType {
    ...
    public EList<Boolean> getBoolean() {
        return getValue().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_Boolean());
    }
    ...
    public EList<CodeType> getCategory() {
        return getValue().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_Category());
    }
    ...
    public EList<MeasureType> getQuantity() {
        return getValue().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_Quantity());
    }
    ...
    public EList<BigInteger> getCount() {
        return getValue().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_Count());
    }
    ...
    public EList<List> getBooleanList() {
        return getValue().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_BooleanList());
    }
    ...
    public EList<CodeOrNullListType> getCategoryList() {
        return getValue().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_CategoryList());
    }
    ...
    public EList<MeasureOrNullListType> getQuantityList() {
        return getValue().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_QuantityList());
    }
    ...
    public EList<List> getCountList() {
        return getValue().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_CountList());
    }
    ...
    public EList<CategoryExtentType> getCategoryExtent() {
        return getValue().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_CategoryExtent());
    }
    ...
    public EList<QuantityExtentType> getQuantityExtent() {
        return getValue().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_QuantityExtent());
    }
    ...
    public EList<List> getCountExtent() {
        return getValue().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_CountExtent());
    }
    ...
    public FeatureMap getCompositeValueGroup() {
        return (FeatureMap)getValue().<FeatureMap.Entry>list(GmlPackage.eINSTANCE.getValueArrayPropertyType_CompositeValueGroup());
    }
    ...
    public EList<CompositeValueType> getCompositeValue() {
        return getCompositeValueGroup().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_CompositeValue());
    }
    ...
    public FeatureMap getObjectGroup() {
        return (FeatureMap)getValue().<FeatureMap.Entry>list(GmlPackage.eINSTANCE.getValueArrayPropertyType_ObjectGroup());
    }
    ...
    public EList<EObject> getObject() {
        return getObjectGroup().list(GmlPackage.eINSTANCE.getValueArrayPropertyType_Object());
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case GmlPackage.VALUE_ARRAY_PROPERTY_TYPE__CATEGORY:
                return ((InternalEList<?>)getCategory()).basicRemove(otherEnd, msgs);
            case GmlPackage.VALUE_ARRAY_PROPERTY_TYPE__QUANTITY:
                return ((InternalEList<?>)getQuantity()).basicRemove(otherEnd, msgs);
            case GmlPackage.VALUE_ARRAY_PROPERTY_TYPE__CATEGORY_LIST:
                return ((InternalEList<?>)getCategoryList()).basicRemove(otherEnd, msgs);
            case GmlPackage.VALUE_ARRAY_PROPERTY_TYPE__QUANTITY_LIST:
                return ((InternalEList<?>)getQuantityList()).basicRemove(otherEnd, msgs);
            case GmlPackage.VALUE_ARRAY_PROPERTY_TYPE__CATEGORY_EXTENT:
                return ((InternalEList<?>)getCategoryExtent()).basicRemove(otherEnd, msgs);
            case GmlPackage.VALUE_ARRAY_PROPERTY_TYPE__QUANTITY_EXTENT:
                return ((InternalEList<?>)getQuantityExtent()).basicRemove(otherEnd, msgs);
            case GmlPackage.VALUE_ARRAY_PROPERTY_TYPE__COMPOSITE_VALUE_GROUP:
                return ((InternalEList<?>)getCompositeValueGroup()).basicRemove(otherEnd, msgs);
            case GmlPackage.VALUE_ARRAY_PROPERTY_TYPE__COMPOSITE_VALUE:
                return ((InternalEList<?>)getCompositeValue()).basicRemove(otherEnd, msgs);
            case GmlPackage.VALUE_ARRAY_PROPERTY_TYPE__OBJECT_GROUP:
                return ((InternalEList<?>)getObjectGroup()).basicRemove(otherEnd, msgs);
            case GmlPackage.VALUE_ARRAY_PROPERTY_TYPE__OBJECT:
