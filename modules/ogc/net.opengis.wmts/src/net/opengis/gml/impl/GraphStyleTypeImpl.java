 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.GraphStyleTypeImpl#isPlanar <em>Planar</em>}</li>
 *   <li>{@link net.opengis.gml.impl.GraphStyleTypeImpl#isDirected <em>Directed</em>}</li>
 *   <li>{@link net.opengis.gml.impl.GraphStyleTypeImpl#isGrid <em>Grid</em>}</li>
 *   <li>{@link net.opengis.gml.impl.GraphStyleTypeImpl#getMinDistance <em>Min Distance</em>}</li>
 *   <li>{@link net.opengis.gml.impl.GraphStyleTypeImpl#getMinAngle <em>Min Angle</em>}</li>
 *   <li>{@link net.opengis.gml.impl.GraphStyleTypeImpl#getGraphType <em>Graph Type</em>}</li>
 *   <li>{@link net.opengis.gml.impl.GraphStyleTypeImpl#getDrawingType <em>Drawing Type</em>}</li>
 *   <li>{@link net.opengis.gml.impl.GraphStyleTypeImpl#getLineType <em>Line Type</em>}</li>
 *   <li>{@link net.opengis.gml.impl.GraphStyleTypeImpl#getAestheticCriteria <em>Aesthetic Criteria</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GraphStyleTypeImpl extends BaseStyleDescriptorTypeImpl implements GraphStyleType {
    ...
    protected EClass eStaticClass() {
        return GmlPackage.eINSTANCE.getGraphStyleType();
    }
    ...
    public void setPlanar(boolean newPlanar) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.GRAPH_STYLE_TYPE__PLANAR, oldPlanar, planar, !oldPlanarESet));
    }
    ...
    public void unsetPlanar() {
        ...
        planarESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.GRAPH_STYLE_TYPE__PLANAR, oldPlanar, PLANAR_EDEFAULT, oldPlanarESet));
    }
    ...
    public void setDirected(boolean newDirected) {
        ...
        directedESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.GRAPH_STYLE_TYPE__DIRECTED, oldDirected, directed, !oldDirectedESet));
    }
    ...
    public void unsetDirected() {
        ...
        directedESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.GRAPH_STYLE_TYPE__DIRECTED, oldDirected, DIRECTED_EDEFAULT, oldDirectedESet));
    }
    ...
    public void setGrid(boolean newGrid) {
        ...
        gridESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.GRAPH_STYLE_TYPE__GRID, oldGrid, grid, !oldGridESet));
    }
    ...
    public void unsetGrid() {
        ...
        gridESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.GRAPH_STYLE_TYPE__GRID, oldGrid, GRID_EDEFAULT, oldGridESet));
    }
    ...
    public void setMinDistance(double newMinDistance) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.GRAPH_STYLE_TYPE__MIN_DISTANCE, oldMinDistance, minDistance, !oldMinDistanceESet));
    }
    ...
    public void unsetMinDistance() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.GRAPH_STYLE_TYPE__MIN_DISTANCE, oldMinDistance, MIN_DISTANCE_EDEFAULT, oldMinDistanceESet));
    }
    ...
    public void setMinAngle(double newMinAngle) {
        ...
        minAngleESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.GRAPH_STYLE_TYPE__MIN_ANGLE, oldMinAngle, minAngle, !oldMinAngleESet));
    }
    ...
    public void unsetMinAngle() {
        ...
        minAngleESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.GRAPH_STYLE_TYPE__MIN_ANGLE, oldMinAngle, MIN_ANGLE_EDEFAULT, oldMinAngleESet));
    }
    ...
    public void setGraphType(GraphTypeType newGraphType) {
        ...
        graphTypeESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.GRAPH_STYLE_TYPE__GRAPH_TYPE, oldGraphType, graphType, !oldGraphTypeESet));
    }
    ...
    public void unsetGraphType() {
        ...
        graphTypeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.GRAPH_STYLE_TYPE__GRAPH_TYPE, oldGraphType, GRAPH_TYPE_EDEFAULT, oldGraphTypeESet));
    }
    ...
    public void setDrawingType(DrawingTypeType newDrawingType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.GRAPH_STYLE_TYPE__DRAWING_TYPE, oldDrawingType, drawingType, !oldDrawingTypeESet));
    }
    ...
    public void unsetDrawingType() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.GRAPH_STYLE_TYPE__DRAWING_TYPE, oldDrawingType, DRAWING_TYPE_EDEFAULT, oldDrawingTypeESet));
    }
    ...
    public void setLineType(LineTypeType newLineType) {
        ...
        lineTypeESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.GRAPH_STYLE_TYPE__LINE_TYPE, oldLineType, lineType, !oldLineTypeESet));
    }
    ...
    public void unsetLineType() {
        ...
        lineTypeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.GRAPH_STYLE_TYPE__LINE_TYPE, oldLineType, LINE_TYPE_EDEFAULT, oldLineTypeESet));
    }
    ...
    public EList<AesheticCriteriaType> getAestheticCriteria() {
        if (aestheticCriteria == null) {
            aestheticCriteria = new EDataTypeEList<AesheticCriteriaType>(AesheticCriteriaType.class, this, GmlPackage.GRAPH_STYLE_TYPE__AESTHETIC_CRITERIA);
        }
