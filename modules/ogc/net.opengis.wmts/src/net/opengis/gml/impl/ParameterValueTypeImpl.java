 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.ParameterValueTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ParameterValueTypeImpl#getDmsAngleValue <em>Dms Angle Value</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ParameterValueTypeImpl#getStringValue <em>String Value</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ParameterValueTypeImpl#getIntegerValue <em>Integer Value</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ParameterValueTypeImpl#isBooleanValue <em>Boolean Value</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ParameterValueTypeImpl#getValueList <em>Value List</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ParameterValueTypeImpl#getIntegerValueList <em>Integer Value List</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ParameterValueTypeImpl#getValueFile <em>Value File</em>}</li>
 *   <li>{@link net.opengis.gml.impl.ParameterValueTypeImpl#getValueOfParameter <em>Value Of Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterValueTypeImpl extends AbstractGeneralParameterValueTypeImpl implements ParameterValueType {
    ...
    public NotificationChain basicSetValueOfParameter(OperationParameterRefType newValueOfParameter, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.PARAMETER_VALUE_TYPE__VALUE_OF_PARAMETER, oldValueOfParameter, newValueOfParameter);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setValueOfParameter(OperationParameterRefType newValueOfParameter) {
        if (newValueOfParameter != valueOfParameter) {
            ...
            if (valueOfParameter != null)
                msgs = ((InternalEObject)valueOfParameter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.PARAMETER_VALUE_TYPE__VALUE_OF_PARAMETER, null, msgs);
            if (newValueOfParameter != null)
                msgs = ((InternalEObject)newValueOfParameter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.PARAMETER_VALUE_TYPE__VALUE_OF_PARAMETER, null, msgs);
            msgs = basicSetValueOfParameter(newValueOfParameter, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.PARAMETER_VALUE_TYPE__VALUE_OF_PARAMETER, newValueOfParameter, newValueOfParameter));
    }
