 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.AbstractReferenceSystemBaseTypeImpl#getSrsName <em>Srs Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractReferenceSystemBaseTypeImpl extends DefinitionTypeImpl implements AbstractReferenceSystemBaseType {
    ...
    protected EClass eStaticClass() {
        return GmlPackage.eINSTANCE.getAbstractReferenceSystemBaseType();
    }
    ...
    public NotificationChain basicSetSrsName(CodeType newSrsName, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_REFERENCE_SYSTEM_BASE_TYPE__SRS_NAME, oldSrsName, newSrsName);
    ...
    public void setSrsName(CodeType newSrsName) {
        if (newSrsName != srsName) {
            ...
            if (srsName != null)
                msgs = ((InternalEObject)srsName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ABSTRACT_REFERENCE_SYSTEM_BASE_TYPE__SRS_NAME, null, msgs);
            if (newSrsName != null)
                msgs = ((InternalEObject)newSrsName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ABSTRACT_REFERENCE_SYSTEM_BASE_TYPE__SRS_NAME, null, msgs);
            msgs = basicSetSrsName(newSrsName, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_REFERENCE_SYSTEM_BASE_TYPE__SRS_NAME, newSrsName, newSrsName));
    }
