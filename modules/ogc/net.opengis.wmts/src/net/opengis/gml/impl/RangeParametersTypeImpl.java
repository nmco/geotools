 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#isBoolean <em>Boolean</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getCount <em>Count</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getBooleanList <em>Boolean List</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getCategoryList <em>Category List</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getQuantityList <em>Quantity List</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getCountList <em>Count List</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getCategoryExtent <em>Category Extent</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getQuantityExtent <em>Quantity Extent</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getCountExtent <em>Count Extent</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getCompositeValueGroup <em>Composite Value Group</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getCompositeValue <em>Composite Value</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml.impl.RangeParametersTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RangeParametersTypeImpl extends MinimalEObjectImpl.Container implements RangeParametersType {
    ...
    protected EClass eStaticClass() {
        return GmlPackage.eINSTANCE.getRangeParametersType();
    }
    ...
    public void setBoolean(boolean newBoolean) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__BOOLEAN, oldBoolean, boolean_, !oldBooleanESet));
    }
    ...
    public void unsetBoolean() {
        ...
        booleanESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.RANGE_PARAMETERS_TYPE__BOOLEAN, oldBoolean, BOOLEAN_EDEFAULT, oldBooleanESet));
    }
    ...
    public NotificationChain basicSetCategory(CodeType newCategory, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__CATEGORY, oldCategory, newCategory);
    ...
    public void setCategory(CodeType newCategory) {
        if (newCategory != category) {
            ...
            if (category != null)
                msgs = ((InternalEObject)category).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.RANGE_PARAMETERS_TYPE__CATEGORY, null, msgs);
            if (newCategory != null)
                msgs = ((InternalEObject)newCategory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.RANGE_PARAMETERS_TYPE__CATEGORY, null, msgs);
            msgs = basicSetCategory(newCategory, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__CATEGORY, newCategory, newCategory));
    }
    ...
    public NotificationChain basicSetQuantity(MeasureType newQuantity, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__QUANTITY, oldQuantity, newQuantity);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setQuantity(MeasureType newQuantity) {
        if (newQuantity != quantity) {
            NotificationChain msgs = null;
            if (quantity != null)
                msgs = ((InternalEObject)quantity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.RANGE_PARAMETERS_TYPE__QUANTITY, null, msgs);
            if (newQuantity != null)
                msgs = ((InternalEObject)newQuantity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.RANGE_PARAMETERS_TYPE__QUANTITY, null, msgs);
            msgs = basicSetQuantity(newQuantity, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__QUANTITY, newQuantity, newQuantity));
    }
    ...
    public void setCount(BigInteger newCount) {
        ...
        count = newCount;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__COUNT, oldCount, count));
    }
    ...
    public void setBooleanList(List<Object> newBooleanList) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__BOOLEAN_LIST, oldBooleanList, booleanList));
    }
    ...
    public NotificationChain basicSetCategoryList(CodeOrNullListType newCategoryList, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__CATEGORY_LIST, oldCategoryList, newCategoryList);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setCategoryList(CodeOrNullListType newCategoryList) {
        if (newCategoryList != categoryList) {
            ...
            if (categoryList != null)
                msgs = ((InternalEObject)categoryList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.RANGE_PARAMETERS_TYPE__CATEGORY_LIST, null, msgs);
            if (newCategoryList != null)
                msgs = ((InternalEObject)newCategoryList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.RANGE_PARAMETERS_TYPE__CATEGORY_LIST, null, msgs);
            msgs = basicSetCategoryList(newCategoryList, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__CATEGORY_LIST, newCategoryList, newCategoryList));
    }
    ...
    public NotificationChain basicSetQuantityList(MeasureOrNullListType newQuantityList, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__QUANTITY_LIST, oldQuantityList, newQuantityList);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setQuantityList(MeasureOrNullListType newQuantityList) {
        if (newQuantityList != quantityList) {
            ...
            if (quantityList != null)
                msgs = ((InternalEObject)quantityList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.RANGE_PARAMETERS_TYPE__QUANTITY_LIST, null, msgs);
            if (newQuantityList != null)
                msgs = ((InternalEObject)newQuantityList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.RANGE_PARAMETERS_TYPE__QUANTITY_LIST, null, msgs);
            msgs = basicSetQuantityList(newQuantityList, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__QUANTITY_LIST, newQuantityList, newQuantityList));
    }
    ...
    public void setCountList(List<Object> newCountList) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__COUNT_LIST, oldCountList, countList));
    }
    ...
    public NotificationChain basicSetCategoryExtent(CategoryExtentType newCategoryExtent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__CATEGORY_EXTENT, oldCategoryExtent, newCategoryExtent);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setCategoryExtent(CategoryExtentType newCategoryExtent) {
        if (newCategoryExtent != categoryExtent) {
            ...
            if (categoryExtent != null)
                msgs = ((InternalEObject)categoryExtent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.RANGE_PARAMETERS_TYPE__CATEGORY_EXTENT, null, msgs);
            if (newCategoryExtent != null)
                msgs = ((InternalEObject)newCategoryExtent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.RANGE_PARAMETERS_TYPE__CATEGORY_EXTENT, null, msgs);
            msgs = basicSetCategoryExtent(newCategoryExtent, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__CATEGORY_EXTENT, newCategoryExtent, newCategoryExtent));
    }
    ...
    public NotificationChain basicSetQuantityExtent(QuantityExtentType newQuantityExtent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__QUANTITY_EXTENT, oldQuantityExtent, newQuantityExtent);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setQuantityExtent(QuantityExtentType newQuantityExtent) {
        if (newQuantityExtent != quantityExtent) {
            ...
            if (quantityExtent != null)
                msgs = ((InternalEObject)quantityExtent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.RANGE_PARAMETERS_TYPE__QUANTITY_EXTENT, null, msgs);
            if (newQuantityExtent != null)
                msgs = ((InternalEObject)newQuantityExtent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.RANGE_PARAMETERS_TYPE__QUANTITY_EXTENT, null, msgs);
            msgs = basicSetQuantityExtent(newQuantityExtent, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__QUANTITY_EXTENT, newQuantityExtent, newQuantityExtent));
    }
    ...
    public void setCountExtent(List<Object> newCountExtent) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__COUNT_EXTENT, oldCountExtent, countExtent));
    }
    ...
    public FeatureMap getCompositeValueGroup() {
        if (compositeValueGroup == null) {
            compositeValueGroup = new BasicFeatureMap(this, GmlPackage.RANGE_PARAMETERS_TYPE__COMPOSITE_VALUE_GROUP);
        }
    ...
    public CompositeValueType getCompositeValue() {
        return (CompositeValueType)getCompositeValueGroup().get(GmlPackage.eINSTANCE.getRangeParametersType_CompositeValue(), true);
    }
    ...
    public NotificationChain basicSetCompositeValue(CompositeValueType newCompositeValue, NotificationChain msgs) {
        return ((FeatureMap.Internal)getCompositeValueGroup()).basicAdd(GmlPackage.eINSTANCE.getRangeParametersType_CompositeValue(), newCompositeValue, msgs);
    }
    ...
    public void setCompositeValue(CompositeValueType newCompositeValue) {
        ((FeatureMap.Internal)getCompositeValueGroup()).set(GmlPackage.eINSTANCE.getRangeParametersType_CompositeValue(), newCompositeValue);
    }
    ...
    public void setActuate(ActuateType newActuate) {
        ...
        actuateESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__ACTUATE, oldActuate, actuate, !oldActuateESet));
    }
    ...
    public void unsetActuate() {
        ...
        actuateESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.RANGE_PARAMETERS_TYPE__ACTUATE, oldActuate, ACTUATE_EDEFAULT, oldActuateESet));
    }
    ...
    public void setArcrole(String newArcrole) {
        ...
        arcrole = newArcrole;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__ARCROLE, oldArcrole, arcrole));
    }
    ...
    public void setHref(String newHref) {
        ...
        href = newHref;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__HREF, oldHref, href));
    }
    ...
    public void setRemoteSchema(String newRemoteSchema) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__REMOTE_SCHEMA, oldRemoteSchema, remoteSchema));
    }
    ...
    public void setRole(String newRole) {
        ...
        role = newRole;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__ROLE, oldRole, role));
    }
    ...
    public void setShow(ShowType newShow) {
        ...
        showESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__SHOW, oldShow, show, !oldShowESet));
    }
    ...
    public void unsetShow() {
        ...
        showESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.RANGE_PARAMETERS_TYPE__SHOW, oldShow, SHOW_EDEFAULT, oldShowESet));
    }
    ...
    public void setTitle(String newTitle) {
        ...
        title = newTitle;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__TITLE, oldTitle, title));
    }
    ...
    public void setType(TypeType newType) {
        ...
        typeESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.RANGE_PARAMETERS_TYPE__TYPE, oldType, type, !oldTypeESet));
    }
    ...
    public void unsetType() {
        ...
        typeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GmlPackage.RANGE_PARAMETERS_TYPE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case GmlPackage.RANGE_PARAMETERS_TYPE__COMPOSITE_VALUE:
