 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.OperationParameterBaseTypeImpl#getParameterName <em>Parameter Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class OperationParameterBaseTypeImpl extends AbstractGeneralOperationParameterTypeImpl implements OperationParameterBaseType {
    ...
    protected EClass eStaticClass() {
        return GmlPackage.eINSTANCE.getOperationParameterBaseType();
    }
    ...
    public NotificationChain basicSetParameterName(CodeType newParameterName, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.OPERATION_PARAMETER_BASE_TYPE__PARAMETER_NAME, oldParameterName, newParameterName);
    ...
    public void setParameterName(CodeType newParameterName) {
        if (newParameterName != parameterName) {
            ...
            if (parameterName != null)
                msgs = ((InternalEObject)parameterName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.OPERATION_PARAMETER_BASE_TYPE__PARAMETER_NAME, null, msgs);
            if (newParameterName != null)
                msgs = ((InternalEObject)newParameterName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.OPERATION_PARAMETER_BASE_TYPE__PARAMETER_NAME, null, msgs);
            msgs = basicSetParameterName(newParameterName, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.OPERATION_PARAMETER_BASE_TYPE__PARAMETER_NAME, newParameterName, newParameterName));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case GmlPackage.OPERATION_PARAMETER_BASE_TYPE__PARAMETER_NAME:
