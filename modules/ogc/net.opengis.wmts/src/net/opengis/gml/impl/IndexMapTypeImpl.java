 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.IndexMapTypeImpl#getLookUpTable <em>Look Up Table</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndexMapTypeImpl extends GridFunctionTypeImpl implements IndexMapType {
    ...
    protected EClass eStaticClass() {
        return GmlPackage.eINSTANCE.getIndexMapType();
    }
    ...
    public void setLookUpTable(List<BigInteger> newLookUpTable) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.INDEX_MAP_TYPE__LOOK_UP_TABLE, oldLookUpTable, lookUpTable));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case GmlPackage.INDEX_MAP_TYPE__LOOK_UP_TABLE:
