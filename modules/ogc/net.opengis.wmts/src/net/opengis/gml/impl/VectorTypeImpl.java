 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.VectorTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml.impl.VectorTypeImpl#getAxisLabels <em>Axis Labels</em>}</li>
 *   <li>{@link net.opengis.gml.impl.VectorTypeImpl#getSrsDimension <em>Srs Dimension</em>}</li>
 *   <li>{@link net.opengis.gml.impl.VectorTypeImpl#getSrsName <em>Srs Name</em>}</li>
 *   <li>{@link net.opengis.gml.impl.VectorTypeImpl#getUomLabels <em>Uom Labels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VectorTypeImpl extends MinimalEObjectImpl.Container implements VectorType {
    ...
    public void setValue(List<Double> newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.VECTOR_TYPE__VALUE, oldValue, value));
    }
    ...
    public void setAxisLabels(List<String> newAxisLabels) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.VECTOR_TYPE__AXIS_LABELS, oldAxisLabels, axisLabels));
    }
    ...
    public void setSrsDimension(BigInteger newSrsDimension) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.VECTOR_TYPE__SRS_DIMENSION, oldSrsDimension, srsDimension));
    }
    ...
    public void setSrsName(String newSrsName) {
        ...
        srsName = newSrsName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.VECTOR_TYPE__SRS_NAME, oldSrsName, srsName));
    }
    ...
    public void setUomLabels(List<String> newUomLabels) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.VECTOR_TYPE__UOM_LABELS, oldUomLabels, uomLabels));
    }
