 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.DerivedCRSTypeImpl#getDerivedCRSType <em>Derived CRS Type</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DerivedCRSTypeImpl#getUsesCS <em>Uses CS</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DerivedCRSTypeImpl extends AbstractGeneralDerivedCRSTypeImpl implements DerivedCRSType {
    ...
    public NotificationChain basicSetUsesCS(CoordinateSystemRefType newUsesCS, NotificationChain msgs) {
        ...
        usesCS = newUsesCS;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.DERIVED_CRS_TYPE__USES_CS, oldUsesCS, newUsesCS);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setUsesCS(CoordinateSystemRefType newUsesCS) {
        if (newUsesCS != usesCS) {
            NotificationChain msgs = null;
            if (usesCS != null)
                msgs = ((InternalEObject)usesCS).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.DERIVED_CRS_TYPE__USES_CS, null, msgs);
            if (newUsesCS != null)
                msgs = ((InternalEObject)newUsesCS).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.DERIVED_CRS_TYPE__USES_CS, null, msgs);
            msgs = basicSetUsesCS(newUsesCS, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.DERIVED_CRS_TYPE__USES_CS, newUsesCS, newUsesCS));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case GmlPackage.DERIVED_CRS_TYPE__USES_CS:
