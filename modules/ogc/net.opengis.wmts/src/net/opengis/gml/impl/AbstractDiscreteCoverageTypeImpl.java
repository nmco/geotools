 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.AbstractDiscreteCoverageTypeImpl#getCoverageFunction <em>Coverage Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractDiscreteCoverageTypeImpl extends AbstractCoverageTypeImpl implements AbstractDiscreteCoverageType {
    ...
    protected EClass eStaticClass() {
        return GmlPackage.eINSTANCE.getAbstractDiscreteCoverageType();
    }
    ...
    public NotificationChain basicSetCoverageFunction(CoverageFunctionType newCoverageFunction, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_DISCRETE_COVERAGE_TYPE__COVERAGE_FUNCTION, oldCoverageFunction, newCoverageFunction);
    ...
    public void setCoverageFunction(CoverageFunctionType newCoverageFunction) {
        if (newCoverageFunction != coverageFunction) {
            ...
            if (coverageFunction != null)
                msgs = ((InternalEObject)coverageFunction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ABSTRACT_DISCRETE_COVERAGE_TYPE__COVERAGE_FUNCTION, null, msgs);
            if (newCoverageFunction != null)
                msgs = ((InternalEObject)newCoverageFunction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GmlPackage.ABSTRACT_DISCRETE_COVERAGE_TYPE__COVERAGE_FUNCTION, null, msgs);
            msgs = basicSetCoverageFunction(newCoverageFunction, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GmlPackage.ABSTRACT_DISCRETE_COVERAGE_TYPE__COVERAGE_FUNCTION, newCoverageFunction, newCoverageFunction));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case GmlPackage.ABSTRACT_DISCRETE_COVERAGE_TYPE__COVERAGE_FUNCTION:
