 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.DictionaryEntryTypeImpl#getDefinitionGroup <em>Definition Group</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DictionaryEntryTypeImpl#getDefinition <em>Definition</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DictionaryEntryTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DictionaryEntryTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DictionaryEntryTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DictionaryEntryTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DictionaryEntryTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DictionaryEntryTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DictionaryEntryTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml.impl.DictionaryEntryTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
