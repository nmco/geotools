 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.impl.BagTypeImpl#getMember <em>Member</em>}</li>
 *   <li>{@link net.opengis.gml.impl.BagTypeImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BagTypeImpl extends AbstractGMLTypeImpl implements BagType {
    ...
    public EList<AssociationType> getMember() {
        if (member == null) {
            member = new EObjectContainmentEList<AssociationType>(AssociationType.class, this, GmlPackage.BAG_TYPE__MEMBER);
        }
        return member;
    }
