 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.BSplineType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml.BSplineType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.BSplineType#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml.BSplineType#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml.BSplineType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml.BSplineType#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link net.opengis.gml.BSplineType#getDegree <em>Degree</em>}</li>
 *   <li>{@link net.opengis.gml.BSplineType#getKnot <em>Knot</em>}</li>
 *   <li>{@link net.opengis.gml.BSplineType#getInterpolation <em>Interpolation</em>}</li>
 *   <li>{@link net.opengis.gml.BSplineType#isIsPolynomial <em>Is Polynomial</em>}</li>
 *   <li>{@link net.opengis.gml.BSplineType#getKnotType <em>Knot Type</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getBSplineType()
...
public interface BSplineType extends AbstractCurveSegmentType {
     ...
     * @see net.opengis.gml.GmlPackage#getBSplineType_Group()
     ...
     * @see net.opengis.gml.GmlPackage#getBSplineType_Pos()
     ...
     * @see net.opengis.gml.GmlPackage#getBSplineType_PointProperty()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see net.opengis.gml.GmlPackage#getBSplineType_PointRep()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see net.opengis.gml.GmlPackage#getBSplineType_PosList()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.BSplineType#getPosList <em>Pos List</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getBSplineType_Coordinates()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.BSplineType#getCoordinates <em>Coordinates</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getBSplineType_Degree()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.BSplineType#getDegree <em>Degree</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link net.opengis.gml.KnotPropertyType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getBSplineType_Knot()
     ...
     * @see net.opengis.gml.GmlPackage#getBSplineType_Interpolation()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.BSplineType#getInterpolation <em>Interpolation</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.BSplineType#getInterpolation <em>Interpolation</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetInterpolation()
     * @see #getInterpolation()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.BSplineType#getInterpolation <em>Interpolation</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getBSplineType_IsPolynomial()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.BSplineType#isIsPolynomial <em>Is Polynomial</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.BSplineType#isIsPolynomial <em>Is Polynomial</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetIsPolynomial()
     * @see #isIsPolynomial()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.BSplineType#isIsPolynomial <em>Is Polynomial</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The literals are from the enumeration {@link net.opengis.gml.KnotTypesType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.gml.KnotTypesType
     * @see #isSetKnotType()
     * @see #unsetKnotType()
     * @see #setKnotType(KnotTypesType)
     * @see net.opengis.gml.GmlPackage#getBSplineType_KnotType()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.BSplineType#getKnotType <em>Knot Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.BSplineType#getKnotType <em>Knot Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetKnotType()
     * @see #getKnotType()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.BSplineType#getKnotType <em>Knot Type</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
