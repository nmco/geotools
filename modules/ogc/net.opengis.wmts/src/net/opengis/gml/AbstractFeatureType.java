 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.AbstractFeatureType#getBoundedBy <em>Bounded By</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractFeatureType#getLocationGroup <em>Location Group</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractFeatureType#getLocation <em>Location</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getAbstractFeatureType()
 * @model abstract="true"
...
public interface AbstractFeatureType extends AbstractGMLType {
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractFeatureType_BoundedBy()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractFeatureType#getBoundedBy <em>Bounded By</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractFeatureType_LocationGroup()
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractFeatureType_Location()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractFeatureType#getLocation <em>Location</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
