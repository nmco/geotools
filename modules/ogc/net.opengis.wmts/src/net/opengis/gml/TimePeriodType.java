 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.TimePeriodType#getBeginPosition <em>Begin Position</em>}</li>
 *   <li>{@link net.opengis.gml.TimePeriodType#getBegin <em>Begin</em>}</li>
 *   <li>{@link net.opengis.gml.TimePeriodType#getEndPosition <em>End Position</em>}</li>
 *   <li>{@link net.opengis.gml.TimePeriodType#getEnd <em>End</em>}</li>
 *   <li>{@link net.opengis.gml.TimePeriodType#getDuration <em>Duration</em>}</li>
 *   <li>{@link net.opengis.gml.TimePeriodType#getTimeInterval <em>Time Interval</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getTimePeriodType()
...
public interface TimePeriodType extends AbstractTimeGeometricPrimitiveType {
     ...
     * @see net.opengis.gml.GmlPackage#getTimePeriodType_BeginPosition()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.TimePeriodType#getBeginPosition <em>Begin Position</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getTimePeriodType_Begin()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.TimePeriodType#getBegin <em>Begin</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getTimePeriodType_EndPosition()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.TimePeriodType#getEndPosition <em>End Position</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getTimePeriodType_End()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.TimePeriodType#getEnd <em>End</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getTimePeriodType_Duration()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.TimePeriodType#getDuration <em>Duration</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getTimePeriodType_TimeInterval()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.TimePeriodType#getTimeInterval <em>Time Interval</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
