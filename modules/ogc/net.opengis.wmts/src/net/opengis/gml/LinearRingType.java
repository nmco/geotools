 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.LinearRingType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml.LinearRingType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.LinearRingType#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml.LinearRingType#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml.LinearRingType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml.LinearRingType#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link net.opengis.gml.LinearRingType#getCoord <em>Coord</em>}</li>
 * </ul>
 *
...
public interface LinearRingType extends AbstractRingType {
     ...
     * @see net.opengis.gml.GmlPackage#getLinearRingType_Group()
     ...
     * @see net.opengis.gml.GmlPackage#getLinearRingType_PointProperty()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see net.opengis.gml.GmlPackage#getLinearRingType_PointRep()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see net.opengis.gml.GmlPackage#getLinearRingType_PosList()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.LinearRingType#getPosList <em>Pos List</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getLinearRingType_Coordinates()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.LinearRingType#getCoordinates <em>Coordinates</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getLinearRingType_Coord()
     * @model containment="true"
