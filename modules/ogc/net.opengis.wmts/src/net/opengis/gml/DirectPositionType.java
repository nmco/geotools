 ...
 *   <li>{@link net.opengis.gml.DirectPositionType#getAxisLabels <em>Axis Labels</em>}</li>
 *   <li>{@link net.opengis.gml.DirectPositionType#getSrsDimension <em>Srs Dimension</em>}</li>
 *   <li>{@link net.opengis.gml.DirectPositionType#getSrsName <em>Srs Name</em>}</li>
 *   <li>{@link net.opengis.gml.DirectPositionType#getUomLabels <em>Uom Labels</em>}</li>
 * </ul>
 *
...
public interface DirectPositionType extends EObject {
     ...
     * @see net.opengis.gml.GmlPackage#getDirectPositionType_AxisLabels()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.DirectPositionType#getAxisLabels <em>Axis Labels</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getDirectPositionType_SrsDimension()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.DirectPositionType#getSrsDimension <em>Srs Dimension</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getDirectPositionType_SrsName()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.DirectPositionType#getSrsName <em>Srs Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getDirectPositionType_UomLabels()
     * @model dataType="net.opengis.gml.NCNameList" many="false"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.DirectPositionType#getUomLabels <em>Uom Labels</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
