 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.DictionaryType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml.DictionaryType#getDictionaryEntryGroup <em>Dictionary Entry Group</em>}</li>
 *   <li>{@link net.opengis.gml.DictionaryType#getDictionaryEntry <em>Dictionary Entry</em>}</li>
 *   <li>{@link net.opengis.gml.DictionaryType#getIndirectEntry <em>Indirect Entry</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getDictionaryType()
...
public interface DictionaryType extends DefinitionType {
     ...
     * @see net.opengis.gml.GmlPackage#getDictionaryType_Group()
     ...
     * @see net.opengis.gml.GmlPackage#getDictionaryType_DictionaryEntryGroup()
     ...
     * The list contents are of type {@link net.opengis.gml.DictionaryEntryType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * An entry in this dictionary. The content of an entry can itself be a lower level dictionary or definition collection. This element follows the standard GML property model, so the value may be provided directly or by reference. Note that if the value is provided by reference, this definition does not carry a handle (gml:id) in this context, so does not allow external references to this specific entry in this context. When used in this way the referenced definition will usually be in a dictionary in the same XML document. 
     ...
     * @see net.opengis.gml.GmlPackage#getDictionaryType_DictionaryEntry()
     ...
     * The list contents are of type {@link net.opengis.gml.IndirectEntryType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getDictionaryType_IndirectEntry()
     * @model containment="true" transient="true" volatile="true" derived="true"
