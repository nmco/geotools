 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.CoverageFunctionType#getMappingRule <em>Mapping Rule</em>}</li>
 *   <li>{@link net.opengis.gml.CoverageFunctionType#getGridFunctionGroup <em>Grid Function Group</em>}</li>
 *   <li>{@link net.opengis.gml.CoverageFunctionType#getGridFunction <em>Grid Function</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getCoverageFunctionType()
...
public interface CoverageFunctionType extends EObject {
     ...
     * @see net.opengis.gml.GmlPackage#getCoverageFunctionType_MappingRule()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.CoverageFunctionType#getMappingRule <em>Mapping Rule</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getCoverageFunctionType_GridFunctionGroup()
     ...
     * @see net.opengis.gml.GmlPackage#getCoverageFunctionType_GridFunction()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.CoverageFunctionType#getGridFunction <em>Grid Function</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
