 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.MovingObjectStatusType#getLocationGroup <em>Location Group</em>}</li>
 *   <li>{@link net.opengis.gml.MovingObjectStatusType#getLocation <em>Location</em>}</li>
 *   <li>{@link net.opengis.gml.MovingObjectStatusType#getSpeed <em>Speed</em>}</li>
 *   <li>{@link net.opengis.gml.MovingObjectStatusType#getBearing <em>Bearing</em>}</li>
 *   <li>{@link net.opengis.gml.MovingObjectStatusType#getAcceleration <em>Acceleration</em>}</li>
 *   <li>{@link net.opengis.gml.MovingObjectStatusType#getElevation <em>Elevation</em>}</li>
 *   <li>{@link net.opengis.gml.MovingObjectStatusType#getStatus <em>Status</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getMovingObjectStatusType()
...
public interface MovingObjectStatusType extends AbstractTimeSliceType {
     ...
     * @see net.opengis.gml.GmlPackage#getMovingObjectStatusType_LocationGroup()
     ...
     * @see net.opengis.gml.GmlPackage#getMovingObjectStatusType_Location()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.MovingObjectStatusType#getLocation <em>Location</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getMovingObjectStatusType_Speed()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.MovingObjectStatusType#getSpeed <em>Speed</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getMovingObjectStatusType_Bearing()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.MovingObjectStatusType#getBearing <em>Bearing</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getMovingObjectStatusType_Acceleration()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.MovingObjectStatusType#getAcceleration <em>Acceleration</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getMovingObjectStatusType_Elevation()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.MovingObjectStatusType#getElevation <em>Elevation</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getMovingObjectStatusType_Status()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.MovingObjectStatusType#getStatus <em>Status</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
