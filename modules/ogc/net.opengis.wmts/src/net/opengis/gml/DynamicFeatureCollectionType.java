 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.DynamicFeatureCollectionType#getValidTime <em>Valid Time</em>}</li>
 *   <li>{@link net.opengis.gml.DynamicFeatureCollectionType#getHistoryGroup <em>History Group</em>}</li>
 *   <li>{@link net.opengis.gml.DynamicFeatureCollectionType#getHistory <em>History</em>}</li>
 *   <li>{@link net.opengis.gml.DynamicFeatureCollectionType#getDataSource <em>Data Source</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getDynamicFeatureCollectionType()
...
public interface DynamicFeatureCollectionType extends FeatureCollectionType {
     ...
     * @see net.opengis.gml.GmlPackage#getDynamicFeatureCollectionType_ValidTime()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.DynamicFeatureCollectionType#getValidTime <em>Valid Time</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getDynamicFeatureCollectionType_HistoryGroup()
     ...
     * @see net.opengis.gml.GmlPackage#getDynamicFeatureCollectionType_History()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.DynamicFeatureCollectionType#getHistory <em>History</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getDynamicFeatureCollectionType_DataSource()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.DynamicFeatureCollectionType#getDataSource <em>Data Source</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
