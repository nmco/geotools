 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.LineStringSegmentType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml.LineStringSegmentType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.LineStringSegmentType#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml.LineStringSegmentType#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml.LineStringSegmentType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml.LineStringSegmentType#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link net.opengis.gml.LineStringSegmentType#getInterpolation <em>Interpolation</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getLineStringSegmentType()
...
public interface LineStringSegmentType extends AbstractCurveSegmentType {
     ...
     * @see net.opengis.gml.GmlPackage#getLineStringSegmentType_Group()
     ...
     * @see net.opengis.gml.GmlPackage#getLineStringSegmentType_Pos()
     ...
     * @see net.opengis.gml.GmlPackage#getLineStringSegmentType_PointProperty()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see net.opengis.gml.GmlPackage#getLineStringSegmentType_PointRep()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see net.opengis.gml.GmlPackage#getLineStringSegmentType_PosList()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.LineStringSegmentType#getPosList <em>Pos List</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getLineStringSegmentType_Coordinates()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.LineStringSegmentType#getCoordinates <em>Coordinates</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getLineStringSegmentType_Interpolation()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.LineStringSegmentType#getInterpolation <em>Interpolation</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.LineStringSegmentType#getInterpolation <em>Interpolation</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetInterpolation()
     * @see #getInterpolation()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.LineStringSegmentType#getInterpolation <em>Interpolation</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
