 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.MeasureListType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml.MeasureListType#getUom <em>Uom</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getMeasureListType()
...
public interface MeasureListType extends EObject {
     ...
     * @see #setValue(List)
     * @see net.opengis.gml.GmlPackage#getMeasureListType_Value()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.MeasureListType#getValue <em>Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setUom(String)
     * @see net.opengis.gml.GmlPackage#getMeasureListType_Uom()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.MeasureListType#getUom <em>Uom</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
