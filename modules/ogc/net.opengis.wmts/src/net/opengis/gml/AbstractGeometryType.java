 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.AbstractGeometryType#getAxisLabels <em>Axis Labels</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractGeometryType#getGid <em>Gid</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractGeometryType#getSrsDimension <em>Srs Dimension</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractGeometryType#getSrsName <em>Srs Name</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractGeometryType#getUomLabels <em>Uom Labels</em>}</li>
 * </ul>
 *
...
public interface AbstractGeometryType extends AbstractGMLType {
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractGeometryType_AxisLabels()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractGeometryType#getAxisLabels <em>Axis Labels</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setGid(String)
     * @see net.opengis.gml.GmlPackage#getAbstractGeometryType_Gid()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractGeometryType#getGid <em>Gid</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractGeometryType_SrsDimension()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractGeometryType#getSrsDimension <em>Srs Dimension</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractGeometryType_UomLabels()
     * @model dataType="net.opengis.gml.NCNameList" many="false"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractGeometryType#getUomLabels <em>Uom Labels</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
