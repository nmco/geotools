 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.ConeType#getHorizontalCurveType <em>Horizontal Curve Type</em>}</li>
 *   <li>{@link net.opengis.gml.ConeType#getVerticalCurveType <em>Vertical Curve Type</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getConeType()
...
public interface ConeType extends AbstractGriddedSurfaceType {
     ...
     * @see net.opengis.gml.GmlPackage#getConeType_HorizontalCurveType()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ConeType#getHorizontalCurveType <em>Horizontal Curve Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.ConeType#getHorizontalCurveType <em>Horizontal Curve Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetHorizontalCurveType()
     * @see #getHorizontalCurveType()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.ConeType#getHorizontalCurveType <em>Horizontal Curve Type</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getConeType_VerticalCurveType()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ConeType#getVerticalCurveType <em>Vertical Curve Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.ConeType#getVerticalCurveType <em>Vertical Curve Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetVerticalCurveType()
     * @see #getVerticalCurveType()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.ConeType#getVerticalCurveType <em>Vertical Curve Type</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
