 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.MultiCurveType#getCurveMember <em>Curve Member</em>}</li>
 *   <li>{@link net.opengis.gml.MultiCurveType#getCurveMembers <em>Curve Members</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getMultiCurveType()
...
public interface MultiCurveType extends AbstractGeometricAggregateType {
     ...
     * @see net.opengis.gml.GmlPackage#getMultiCurveType_CurveMember()
     ...
     * @see net.opengis.gml.GmlPackage#getMultiCurveType_CurveMembers()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.MultiCurveType#getCurveMembers <em>Curve Members</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
