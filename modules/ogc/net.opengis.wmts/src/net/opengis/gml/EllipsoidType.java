 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.EllipsoidType#getEllipsoidID <em>Ellipsoid ID</em>}</li>
 *   <li>{@link net.opengis.gml.EllipsoidType#getRemarks <em>Remarks</em>}</li>
 *   <li>{@link net.opengis.gml.EllipsoidType#getSemiMajorAxis <em>Semi Major Axis</em>}</li>
 *   <li>{@link net.opengis.gml.EllipsoidType#getSecondDefiningParameter <em>Second Defining Parameter</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getEllipsoidType()
...
public interface EllipsoidType extends EllipsoidBaseType {
     ...
     * @see net.opengis.gml.GmlPackage#getEllipsoidType_EllipsoidID()
     ...
     * @see net.opengis.gml.GmlPackage#getEllipsoidType_Remarks()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.EllipsoidType#getRemarks <em>Remarks</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getEllipsoidType_SemiMajorAxis()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.EllipsoidType#getSemiMajorAxis <em>Semi Major Axis</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getEllipsoidType_SecondDefiningParameter()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.EllipsoidType#getSecondDefiningParameter <em>Second Defining Parameter</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
