 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.OrientableSurfaceType#getBaseSurface <em>Base Surface</em>}</li>
 *   <li>{@link net.opengis.gml.OrientableSurfaceType#getOrientation <em>Orientation</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getOrientableSurfaceType()
...
public interface OrientableSurfaceType extends AbstractSurfaceType {
     ...
     * @see net.opengis.gml.GmlPackage#getOrientableSurfaceType_BaseSurface()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.OrientableSurfaceType#getBaseSurface <em>Base Surface</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getOrientableSurfaceType_Orientation()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.OrientableSurfaceType#getOrientation <em>Orientation</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.OrientableSurfaceType#getOrientation <em>Orientation</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetOrientation()
     * @see #getOrientation()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.OrientableSurfaceType#getOrientation <em>Orientation</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
