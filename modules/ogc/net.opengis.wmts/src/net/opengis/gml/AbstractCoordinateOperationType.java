 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.AbstractCoordinateOperationType#getCoordinateOperationID <em>Coordinate Operation ID</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractCoordinateOperationType#getRemarks <em>Remarks</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractCoordinateOperationType#getOperationVersion <em>Operation Version</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractCoordinateOperationType#getValidArea <em>Valid Area</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractCoordinateOperationType#getScope <em>Scope</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractCoordinateOperationType#getPositionalAccuracyGroup <em>Positional Accuracy Group</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractCoordinateOperationType#getPositionalAccuracy <em>Positional Accuracy</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractCoordinateOperationType#getSourceCRS <em>Source CRS</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractCoordinateOperationType#getTargetCRS <em>Target CRS</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getAbstractCoordinateOperationType()
 * @model abstract="true"
...
public interface AbstractCoordinateOperationType extends AbstractCoordinateOperationBaseType {
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractCoordinateOperationType_CoordinateOperationID()
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractCoordinateOperationType_Remarks()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractCoordinateOperationType#getRemarks <em>Remarks</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractCoordinateOperationType_OperationVersion()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractCoordinateOperationType#getOperationVersion <em>Operation Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractCoordinateOperationType_ValidArea()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractCoordinateOperationType#getValidArea <em>Valid Area</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setScope(String)
     * @see net.opengis.gml.GmlPackage#getAbstractCoordinateOperationType_Scope()
     * @model dataType="org.eclipse.emf.ecore.xml.type.String"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractCoordinateOperationType#getScope <em>Scope</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractCoordinateOperationType_PositionalAccuracyGroup()
     ...
     * The list contents are of type {@link net.opengis.gml.AbstractPositionalAccuracyType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * Unordered set of estimates of the impact of this coordinate operation on point position accuracy. Gives position error estimates for target coordinates of this coordinate operation, assuming no errors in source coordinates. 
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractCoordinateOperationType_PositionalAccuracy()
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractCoordinateOperationType_SourceCRS()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractCoordinateOperationType#getSourceCRS <em>Source CRS</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractCoordinateOperationType_TargetCRS()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractCoordinateOperationType#getTargetCRS <em>Target CRS</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
