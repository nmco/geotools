 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.IdentifierType#getNameGroup <em>Name Group</em>}</li>
 *   <li>{@link net.opengis.gml.IdentifierType#getName <em>Name</em>}</li>
 *   <li>{@link net.opengis.gml.IdentifierType#getVersion <em>Version</em>}</li>
 *   <li>{@link net.opengis.gml.IdentifierType#getRemarks <em>Remarks</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getIdentifierType()
...
public interface IdentifierType extends EObject {
     ...
     * @see net.opengis.gml.GmlPackage#getIdentifierType_NameGroup()
     ...
     * @see net.opengis.gml.GmlPackage#getIdentifierType_Name()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.IdentifierType#getName <em>Name</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getIdentifierType_Version()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.IdentifierType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getIdentifierType_Remarks()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.IdentifierType#getRemarks <em>Remarks</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
