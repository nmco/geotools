 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.AbstractDatumType#getDatumID <em>Datum ID</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractDatumType#getRemarks <em>Remarks</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractDatumType#getAnchorPoint <em>Anchor Point</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractDatumType#getRealizationEpoch <em>Realization Epoch</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractDatumType#getValidArea <em>Valid Area</em>}</li>
 *   <li>{@link net.opengis.gml.AbstractDatumType#getScope <em>Scope</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getAbstractDatumType()
 * @model abstract="true"
...
public interface AbstractDatumType extends AbstractDatumBaseType {
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractDatumType_DatumID()
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractDatumType_Remarks()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractDatumType#getRemarks <em>Remarks</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractDatumType_AnchorPoint()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractDatumType#getAnchorPoint <em>Anchor Point</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractDatumType_RealizationEpoch()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractDatumType#getRealizationEpoch <em>Realization Epoch</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getAbstractDatumType_ValidArea()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractDatumType#getValidArea <em>Valid Area</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setScope(String)
     * @see net.opengis.gml.GmlPackage#getAbstractDatumType_Scope()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.AbstractDatumType#getScope <em>Scope</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
