 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.TimeClockType#getReferenceEvent <em>Reference Event</em>}</li>
 *   <li>{@link net.opengis.gml.TimeClockType#getReferenceTime <em>Reference Time</em>}</li>
 *   <li>{@link net.opengis.gml.TimeClockType#getUtcReference <em>Utc Reference</em>}</li>
 *   <li>{@link net.opengis.gml.TimeClockType#getDateBasis <em>Date Basis</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getTimeClockType()
...
public interface TimeClockType extends AbstractTimeReferenceSystemType {
     ...
     * @see net.opengis.gml.GmlPackage#getTimeClockType_ReferenceEvent()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.TimeClockType#getReferenceEvent <em>Reference Event</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getTimeClockType_ReferenceTime()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.TimeClockType#getReferenceTime <em>Reference Time</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getTimeClockType_UtcReference()
     * @model dataType="org.eclipse.emf.ecore.xml.type.Time" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.TimeClockType#getUtcReference <em>Utc Reference</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link net.opengis.gml.TimeCalendarPropertyType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.gml.GmlPackage#getTimeClockType_DateBasis()
