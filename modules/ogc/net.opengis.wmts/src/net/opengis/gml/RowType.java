 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.RowType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml.RowType#getGeometricPositionGroup <em>Geometric Position Group</em>}</li>
 *   <li>{@link net.opengis.gml.RowType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.RowType#getPointProperty <em>Point Property</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getRowType()
...
public interface RowType extends EObject {
     ...
     * @see net.opengis.gml.GmlPackage#getRowType_PosList()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.RowType#getPosList <em>Pos List</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getRowType_GeometricPositionGroup()
     ...
     * @see net.opengis.gml.GmlPackage#getRowType_Pos()
     ...
     * @see net.opengis.gml.GmlPackage#getRowType_PointProperty()
     * @model containment="true" transient="true" volatile="true" derived="true"
