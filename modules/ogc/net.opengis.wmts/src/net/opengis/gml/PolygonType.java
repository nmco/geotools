 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.PolygonType#getExteriorGroup <em>Exterior Group</em>}</li>
 *   <li>{@link net.opengis.gml.PolygonType#getExterior <em>Exterior</em>}</li>
 *   <li>{@link net.opengis.gml.PolygonType#getInteriorGroup <em>Interior Group</em>}</li>
...
public interface PolygonType extends AbstractSurfaceType {
     ...
     * @see net.opengis.gml.GmlPackage#getPolygonType_ExteriorGroup()
     ...
     * @see net.opengis.gml.GmlPackage#getPolygonType_InteriorGroup()
