 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.SphereType#getHorizontalCurveType <em>Horizontal Curve Type</em>}</li>
 *   <li>{@link net.opengis.gml.SphereType#getVerticalCurveType <em>Vertical Curve Type</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getSphereType()
...
public interface SphereType extends AbstractGriddedSurfaceType {
     ...
     * @see net.opengis.gml.GmlPackage#getSphereType_HorizontalCurveType()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.SphereType#getHorizontalCurveType <em>Horizontal Curve Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.SphereType#getHorizontalCurveType <em>Horizontal Curve Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetHorizontalCurveType()
     * @see #getHorizontalCurveType()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.SphereType#getHorizontalCurveType <em>Horizontal Curve Type</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getSphereType_VerticalCurveType()
     * @model default="circularArc3Points" unsettable="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.SphereType#getVerticalCurveType <em>Vertical Curve Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml.SphereType#getVerticalCurveType <em>Vertical Curve Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetVerticalCurveType()
     * @see #getVerticalCurveType()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml.SphereType#getVerticalCurveType <em>Vertical Curve Type</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
