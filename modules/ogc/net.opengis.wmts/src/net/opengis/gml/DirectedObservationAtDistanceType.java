 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.DirectedObservationAtDistanceType#getDistance <em>Distance</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getDirectedObservationAtDistanceType()
...
public interface DirectedObservationAtDistanceType extends DirectedObservationType {
     ...
     * @see net.opengis.gml.GmlPackage#getDirectedObservationAtDistanceType_Distance()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.DirectedObservationAtDistanceType#getDistance <em>Distance</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
