 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.CoordinateSystemAxisType#getAxisID <em>Axis ID</em>}</li>
 *   <li>{@link net.opengis.gml.CoordinateSystemAxisType#getRemarks <em>Remarks</em>}</li>
 *   <li>{@link net.opengis.gml.CoordinateSystemAxisType#getAxisAbbrev <em>Axis Abbrev</em>}</li>
 *   <li>{@link net.opengis.gml.CoordinateSystemAxisType#getAxisDirection <em>Axis Direction</em>}</li>
 *   <li>{@link net.opengis.gml.CoordinateSystemAxisType#getUom <em>Uom</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getCoordinateSystemAxisType()
...
public interface CoordinateSystemAxisType extends CoordinateSystemAxisBaseType {
     ...
     * @see net.opengis.gml.GmlPackage#getCoordinateSystemAxisType_AxisID()
     ...
     * @see net.opengis.gml.GmlPackage#getCoordinateSystemAxisType_Remarks()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.CoordinateSystemAxisType#getRemarks <em>Remarks</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getCoordinateSystemAxisType_AxisAbbrev()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.CoordinateSystemAxisType#getAxisAbbrev <em>Axis Abbrev</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getCoordinateSystemAxisType_AxisDirection()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.CoordinateSystemAxisType#getAxisDirection <em>Axis Direction</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setUom(String)
     * @see net.opengis.gml.GmlPackage#getCoordinateSystemAxisType_Uom()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.CoordinateSystemAxisType#getUom <em>Uom</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
