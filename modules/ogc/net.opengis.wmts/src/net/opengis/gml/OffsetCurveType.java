 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.OffsetCurveType#getOffsetBase <em>Offset Base</em>}</li>
 *   <li>{@link net.opengis.gml.OffsetCurveType#getDistance <em>Distance</em>}</li>
 *   <li>{@link net.opengis.gml.OffsetCurveType#getRefDirection <em>Ref Direction</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getOffsetCurveType()
...
public interface OffsetCurveType extends AbstractCurveSegmentType {
     ...
     * @see net.opengis.gml.GmlPackage#getOffsetCurveType_OffsetBase()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.OffsetCurveType#getOffsetBase <em>Offset Base</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getOffsetCurveType_Distance()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.OffsetCurveType#getDistance <em>Distance</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml.GmlPackage#getOffsetCurveType_RefDirection()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.OffsetCurveType#getRefDirection <em>Ref Direction</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
