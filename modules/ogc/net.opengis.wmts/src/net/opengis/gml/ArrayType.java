 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.ArrayType#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getArrayType()
...
public interface ArrayType extends AbstractGMLType {
     ...
     * @see net.opengis.gml.GmlPackage#getArrayType_Members()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.ArrayType#getMembers <em>Members</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
