 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.EdgeType#getDirectedNode <em>Directed Node</em>}</li>
 *   <li>{@link net.opengis.gml.EdgeType#getDirectedFace <em>Directed Face</em>}</li>
 *   <li>{@link net.opengis.gml.EdgeType#getCurveProperty <em>Curve Property</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getEdgeType()
...
public interface EdgeType extends AbstractTopoPrimitiveType {
     ...
     * The list contents are of type {@link net.opengis.gml.DirectedNodePropertyType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.gml.GmlPackage#getEdgeType_DirectedNode()
     ...
     * @see net.opengis.gml.GmlPackage#getEdgeType_DirectedFace()
     ...
     * @see net.opengis.gml.GmlPackage#getEdgeType_CurveProperty()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml.EdgeType#getCurveProperty <em>Curve Property</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
